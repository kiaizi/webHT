...
<!-- Contact Us Page Banner & Title -->
  ...
  <div class="contaniner-fluid">
    <div class="title-bg">
      <div class="col-lg-12 ctm-width"><span class="square"></span><h3>Contact Us</h3></div>
    </div>
  </div>
...
?>
      ...
      <div class="col-lg-6 col-12">
        <h3 class="list-title">Dealing Hotline- 24h Services</h3>
          <table>
            <tbody>
...
?>  	  
  ...
  <div class="container mt-5 contact-wrappar-02">
    <div class="row">
      <div class="col-lg-6 col-12">
        <h3 class="list-title">Client Services</h3>
          <table>
            <tbody>
