	...
	if($G_DB_CONNECT->affected_rows > 0){
			while($data = $G_DB_CONNECT->fetch_array($rows)){
				...
				if($trading_market_category_id == 1){
					$trading_market_category_name  = 'China Market';
				}else if($trading_market_category_id == 2){
					$trading_market_category_name  = 'Hong Kong & Global Market';
				}
    ...
    <!-- News PDF Page Content - Right Side -->
      <div class="col-lg-9 col-12 pt-lg-3 pl-lg-5">
        <div class="col-12 mt-2 mb-2">
          <span class="head_sction_link">Business > <?php echo $trading_market_category_name; ?> > <span style="border-bottom: 2px solid #D93A16;"><?php echo $trading_market_name; ?></span></span>
        </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <?php
                      if($_GET['id']==3) {
                    ?>
                    <th rowspan="8" class="md-left-tb"><img src="../images/mc-SHFE-timeline.svg" class="mc-SHFE-img-m2"></th>
                    <?php }else{ ?> 

                    <th rowspan="8" class="md-left-tb"><img src="../images/mc-SHFE-timeline-01.jpg" class="mc-SHFE-img-m"></th>
                    <?php } ?>
