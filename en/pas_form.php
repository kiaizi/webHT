...
<!-- Product and Service Form Page -->
  ...
  <div class="contaniner-fluid">
    <div class="title-bg">
      <div class="col-lg-12 ctm-width"><span class="square"></span><h3>Forms</h3></div>
    </div>
  </div>
...
?>
        ...
        <div class="col-lg-3 col-6"><?php echo $title ?>
          ...
          <span class="pas-form-text"><a href="<?php echo $file ; ?>" download="<?php echo $title_text ; ?>" >Click to Download</span><span><img src="../images/download.svg" alt=""></a></span>
        </div>
