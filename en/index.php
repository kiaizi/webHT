...
?>
	...
	if($home_banner_url != ''){
?>
          <a href="<?php echo $home_banner_url; ?>" target="<?php echo $home_banner_url_target; ?>"><div class="know_more_btn_1 m-2">More</div></a>
		  <?php
	}
?>
<?php
	if($home_banner_url2 != ''){
?>
          <a href="<?php echo $home_banner_url2; ?>" target="<?php echo $home_banner_url_target2; ?>"><div class="red_btn_1 m-2">Account Opening</div></a>
		  <?php
	}
?> 
<?php
	if($img3 != ''){
?>
          <a href="<?php echo $img3; ?>" target="_blank"><div class="know_more_btn_1 m-2">Company Brochure</div></a>
		  <?php
	}
?> 
        </div>
...
<div class="container pt-5 pb-lg-5 con_mt"  style="max-width: 90%;">
  ...
  <div class="col-lg-3 col-12 text-lg-left text-center pb-3 news_head_title">
    <span class="title_1_rline">Huatai News</span>
...
?>
    <div class="item">
      ...
      <div class="idx_news_box_1 pb-3 mb-5"><a href="<?php echo $link; ?>"><img src="<?php echo $img; ?>" width="100%"></a><div class="idx_news_title_1"><?php echo $news_category_name ; ?></div><div class="idx_news_content_1"><?php echo $news_name; ?>
      <br><br>
    <div class="know_more_btn_2 m-0 btn_link" href="<?php echo $link; ?>">More&nbsp;&nbsp;<img src="../images/index/kw_more_arr.svg" height="15" class="img_mb_5"></div>
...
<div class="container pt-5 pb-5"  style="max-width: 100%;">
  ...
  <div class="col-12 text-center pb-lg-5 pb-3">
    <span class="title_1_rline">China & Asia- Pacific Markets</span>
  </div>
  </div>
...
?>
    <div class="item btn_link" href="<?php echo $link ?>">
...
<div class="container" style="max-width: 90%;">
  ...
  <div class="col-12 text-center pt-lg-5 pb-lg-5 pt-3 pb-3">
    <span class="title_1_rline" style="color: white;">Softwares</span>
  </div>
  </div>
  <div class="row">
...
?>
        <div class="col-lg-3 col-6 p-lg-2 p-1">
          <a href="<?php echo $home_promotion2_url;?>" target="<?php echo $home_promotion2_url_target;?>">
...
?>
    ...
    <div class="col-12 text-center pb-5">
      <div class="know_more_btn_2 btn_link" href="<?php echo $other_link; ?>" target="<?php echo $other_link_target; ?>">More&nbsp;&nbsp;<img src="../images/index/kw_more_arr.svg" height="15" class="img_mb_5"></div>
    </div>
  </div>
</div>
