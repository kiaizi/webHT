    ...
    <nav class="navbar navbar-light navbar-expand-md bg-faded justify-content-center red-border">
      ...
      <div class="navbar-collapse collapse w-100" id="collapsingNavbar3">
        <ul class="navbar-nav nav ml-auto w-100 justify-content-end" id="nav">
          <li class="nav-item">
            <a class="nav-link<?php if($a==0){?> active <?php } ?>" href="index.php">Home <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link<?php if($a==1){?> active <?php } ?>" href="about_us.php">About Us</a>
          </li>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="drop1">
              <a class="dropdown-item" href="news_list.php">Huatai News</a>
              <a class="dropdown-item" href="news_pdf.php">Notices</a>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="drop3">
              <a class="dropdown-item" href="pas_reg_pnb.php">Contract Spec & Margin</a>
              <a class="dropdown-item" href="calendar_holidays.php">Exchange Holidays</a>
              <a class="dropdown-item" href="calendar_futures.php">Last Trading Days</a>
            </div>
          </li>
          <li class="nav-item dropdown">
           <a class="nav-link dropdown-toggle<?php if($a==5){?> active <?php } ?>" href="#" id="drop4" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="dropdown-menu" aria-labelledby="drop4">
              <a class="dropdown-item" href="pas_reg_ac.php">Account Opening</a>
              <a class="dropdown-item" href="pas_client_deposit.php">Fund Deposits & Withdrawal</a>
              <a class="dropdown-item" href="pas_software.php">Softwares</a>
              <a class="dropdown-item" href="pas_form.php">Forms</a>
              <a class="dropdown-item" href="pas_faq.php">FAQs</a>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link<?php if($a==6){?> active <?php } ?>" href="contact_us.php">Contact Us</a>
          </li>
        </ul>
      </div>
    </nav>
