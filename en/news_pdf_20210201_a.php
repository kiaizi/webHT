    ...
    <!-- News PDF Page Content - Left Side -->
        <div class="col-lg-2 col-12 left-side-list">
          <div class="card-header">
            ...
            通告类别<!--<i class="card-header-icon fa fa-plus-circle" aria-hidden="true"></i>-->
            </ul>
          </div>
...
?>
			<div class="list-content">
              <div class="list-c-text">
                <li><a href="<?php echo $file ?>" download="<?php echo $important_notice_name ?>" ><span class="rsl-text"><?php echo $important_notice_name ?></span><span class="rsl-red-text">点击此处下载<img src="../images/download.svg" alt="" class="rsl-img"></span></a></li>
              </div>
            </div>
