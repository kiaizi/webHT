...
<!-- Product and Service Software Page Banner and Title -->
  ...
  <div class="contaniner-fluid">
    <div class="title-bg">
      <div class="col-lg-12 ctm-width"><span class="square"></span><h3>Softwares</h3></div>
    </div>
  </div>
      ...
      <div class="pap-text">
          <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li class="nav-item">
              ...
              <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true"><div class="pap-img-01"><img src="../images/software-01.png" alt="" class="si-01"></div><span>Esunny</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false"><div class="pap-img-02"><img src="../images/software-02.png" alt="" class="si-02"></div><span>ATP</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false"><div class="pap-img-03"><img src="../images/software-03.png" alt="" class="si-03"></div><span>TT</span></a>
            </li>
          </ul>
      </div>
                  ...
                  <?php echo $download_software_detail; ?>
                      ...
                      <div class="atp-dl-file">
                        ...
                        <div class="col-lg-4 col-6">
                          ...
                          <p class="mddf-red-text"><a href="<?php echo $file ; ?>"  download="<?php echo $title_text ; ?>" >Click to Download<span class="mddf-red-img"><img src="../images/download.svg" alt=""></span></a></p>
                        </div>
