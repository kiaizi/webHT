    ...
    <!-- One -->
      <div class="card">
        <div class="card-header" id="headingOne">
          <h2 class="mb-0">
            <button class="btn btn-link <?php if($trading_market_category_id ==1 ) { ?>collapsed<?php } ?>" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
              China Market
            </button>
          </h2>
        </div>
        ...
        <!-- One ~ Body -->
          <div id="collapseOne" class="collapse <?php if($trading_market_category_id==1 ) { ?>show<?php } ?>" aria-labelledby="headingOne" data-parent="#accordionExample">
            <div class="card-body">
...
?>	
                <li class="nav-item">
                  <a class="nav-link <?php if($trading_market_id==ID) { ?>active<?php } ?>" href="<?php echo $link; ?>"><span><?php echo $trading_market_name; ?></span></a>
                </li>
     <?php
    ...
    <!-- Two -->
      <div class="card">
        <div class="card-header" id="headingTwo">
          <h2 class="mb-0">
            <button class="btn btn-link <?php if($trading_market_category_id ==2) { ?>collapsed<?php } ?>" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
        ...
        <!-- Two ~ Body -->
          <div id="collapseTwo" class="collapse <?php if($trading_market_category_id ==2) { ?>show<?php } ?>" aria-labelledby="headingTwo" data-parent="#accordionExample">
            <div class="card-body">
              <ul class="nav flex-column">
...
?>		 
      ...
      <div class="card">
        <div class="card-header" id="headingThree">
          <h2 class="mb-0">
            <button class="btn btn-link <?php if(IN_API==1) { ?>collapsed<?php } ?>" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
        ...
        <!-- Two ~ Body -->
          <div id="collapseThree" class="collapse <?php if(IN_API==1) { ?>show<?php } ?>" aria-labelledby="headingThree" data-parent="#accordionExample">
            <div class="card-body">
              <ul class="nav flex-column">
...
?>			  
                <li class="nav-item">
                  <a class="nav-link <?php if($trading_support_id==ID) { ?>active<?php } ?>" href="market_coverage_API.php?id=<?php echo $trading_support_id;?>"><span><?php echo $trading_support_name;?></span></a>
                </li>
