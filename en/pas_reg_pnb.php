...
<!-- Reg_AC Page Banner & Title -->
  ...
  <div class="contaniner-fluid">
    <div class="title-bg">
      <div class="col-lg-12 ctm-width"><span class="square"></span><h3>Contract Spec & Margin</h3></div>
    </div>
  </div>
...
<!-- Reg_AC Page Content -->
  <div class="container reg_ac_content">
    <div class="row">
       <div class="col-lg-12">
          <div class="personal"><ion-icon name="add-circle"></ion-icon><span><a href="../en/market_coverage_contract.php">Contract Specs</a></span></div>
          <div class="organization"><ion-icon name="add-circle"></ion-icon><span><a href="../en/market_coverage_margins.php">Margins</a></span></div>
       </div>
    </div>
  </div>
