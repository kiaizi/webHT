...
<!-- Reg_AC Page Content -->
  <div class="container reg_ac_content">
    <div class="row">
       <div class="col-lg-12">
          <div class="personal"><ion-icon name="add-circle"></ion-icon><span><a href="../en/pas_reg_ac_online.php">Online Account Opening- Individual Clients</a></span></div>
          <div class="organization"><ion-icon name="add-circle"></ion-icon><span><a href="../en/pas_reg_ac_offline.php">Account Opening- Counter Services for Corporate & Individual Clients</a></span></div>
          <div class="organization"><ion-icon name="add-circle"></ion-icon><span><a href="../en/pas_reg_ac_openacc.php">Additional Documents for Chinese Product Trading Application</a></span></div>
       </div>
    </div>
  </div>
