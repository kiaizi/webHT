...
<!-- News PDF Page Banner & Title -->
  ...
  <div class="contaniner-fluid">
    <div class="title-bg">
      <div class="col-lg-12 ctm-width"><span class="square"></span><h3>Notices</h3></div>
    </div>
  </div>
    ...
    <!-- News PDF Page Content - Left Side -->
        <div class="col-lg-2 col-12 left-side-list">
          <div class="card-header">
            ...
            Categories<!--<i class="card-header-icon fa fa-plus-circle" aria-hidden="true"></i>-->
            </ul>
          </div>
...
?>
    ...
    <!-- News PDF Page Content - Right Side -->
      <div class="col-lg-10 col-12 right-side-list">
        <div class="row pb-3">
          <div class="col-7 pr-0 text-left news_text2">Notices</div>
          <div class="col-5 pl-lg-0 pl-1 text-left news_text2">Updated Time</div>
        </div>
			...
			<div class="list-content">
              <div class="list-c-text">
                <li>
                    <div class="row">
                      <div class="col-7">
                    <span class="rsl-text"><?php echo $important_notice_name ?></span>
                      </div>
                      <div class="col-3">
                  ...
                  <a href="<?php echo $file ?>" download="<?php echo $important_notice_name ?>" ><img src="../images/download.svg" alt="" class="rsl-img">
                  </a>
                      </div>
                    </div>
