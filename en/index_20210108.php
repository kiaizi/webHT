...
?>
	...
	if($home_banner_url != ''){
?>
          <a href="<?php echo $home_banner_url; ?>" target="<?php echo $home_banner_url_target; ?>"><div class="know_more_btn_1 m-2">了解更多</div></a>
		  <?php
	}
?>
<?php
	if($home_banner_url2 != ''){
?>
          <a href="<?php echo $home_banner_url2; ?>" target="<?php echo $home_banner_url_target2; ?>"><div class="red_btn_1 m-2">网上开户</div></a>
		  <?php
	}
?> 
        </div>
...
?>
    <div class="item">
      ...
      <br><br>
    <div class="know_more_btn_2 m-0 btn_link" href="<?php echo $link; ?>">了解更多&nbsp;&nbsp;<img src="../images/index/kw_more_arr.svg" height="15" class="img_mb_5"></div>
...
<div class="index_bg_2" style="background-image:url(<?php echo $img; ?>)">
...
?>
    ...
    <div class="col-12 text-center pb-5">
      <div class="know_more_btn_2 btn_link" href="<?php echo $other_link; ?>" target="<?php echo $other_link_target; ?>">了解更多&nbsp;&nbsp;<img src="../images/index/kw_more_arr.svg" height="15" class="img_mb_5"></div>
    </div>
  </div>
</div>
