    ...
    <div class="row">
      <div class="col-12 mt-5 mb-5">
        <div class="market_api_box">
          <div class="box_head" id="data"><div class="box_head_title_1">Quantatitive & Program Trading</div></div>
...
?>
          ...
          <div class="col-12 text-center p-3">
            <a href="market_coverage_API.php?id=<?php echo $trading_support_id;?>"><div class="know_more_btn_2">More&nbsp;&nbsp;<img src="../images/index/kw_more_arr.svg" height="25" class="img_mb_5"></div></a>
          </div>
...
<div class="tab row">
  ...
  <button class="tablinks market_tab_title" onclick="openCity(event, 'market_all')" <?php if ($_GET{'mcl'}=="") { ?>id="defaultOpen"<?php } ?>>All</button>
  <button class="tablinks market_tab_title" onclick="openCity(event, 'market_china')" <?php if ($_GET{'mcl'}=="cn") { ?>id="defaultOpen"<?php } ?>>China Market</button>
  <button class="tablinks market_tab_title" onclick="openCity(event, 'market_hknothers')" <?php if ($_GET{'mcl'}=="hk") { ?>id="defaultOpen"<?php } ?>>Hong Kong & Global Market</button>
  </div>
</div>
