...
?>
            <div class="online-manual"><?php echo $title ; ?>
              <p><img src="<?php echo $img ; ?>" alt="" class="om-img" style="max-height:80px;"><br><span class="manual-text">点击此处下载</span><a href="<?php echo $file ; ?>"  download="<?php echo $title_text ; ?>" class="form-img-text"><img src="../images/download.svg" download></p>
            </div>
