...
<img src="../images/market_contact_banner.jpg" width="100%" class="bottom_red_line">

  <div class="container pt-3 pb-3 first-col">
    <div class="row">
      <div class="col-12 mt-2 mb2">
        <span class="head_sction_link">市场资讯 > 产品及保证金 > <span style="border-bottom: 2px solid #D93A16;">保证金資料</span></span>
      </div>
    </div>
  </div>
...
?>	
                ...
                <div class="col-lg-3 col-7 pb-1 pr-1">
                  <div class="market_table_search1">
                      ...
                      <input type="text" name="s" id="s" value="<?php echo $_REQUEST['s'];?>" class="form-control searchbar_input" placeholder="品种编号/交易所代碼" aria-label="品种编号/交易所代碼" aria-describedby="button-addon2">
...
?>	  
      ...
      <table class="market_table_width" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <th style="width: 110px;">交易所</th>
          <th style="width: 80px;">品种编号</th>
          <th style="width: 120px;">品种</th>
          <th style="width: 120px;">货币</th>
          <th style="width: 170px;">初始保证金</th>
          <th style="width: 120px;">维持保证金</th>
        </tr>
