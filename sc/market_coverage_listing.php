...
<div class="tab row">
  ...
  <button class="tablinks market_tab_title" onclick="openCity(event, 'market_china')" <?php if ($_GET{'mcl'}=="cn") { ?>id="defaultOpen"<?php } ?>>中国市场</button>
  <button class="tablinks market_tab_title" onclick="openCity(event, 'market_hknothers')" <?php if ($_GET{'mcl'}=="hk") { ?>id="defaultOpen"<?php } ?>>香港及海外市场</button>
  </div>
</div>
