    ...
    <div class="container-fluid bg_light header-page">
      <div class="top">
        <div class="topnav">
          ...
          <a class="lag" href="#">简</a>
          <a class="lag active"href="#">EN</a>
  ...
  <!-- Header Page Header Navbar -->
    <nav class="navbar navbar-light navbar-expand-md bg-faded justify-content-center red-border">
      <a href="index.php" class="navbar-brand d-flex w-50 mr-auto pl-4">
        <img src="../images/logo.png"  class="company-logo header-page" width="100%">
      </a>
        ...
        <ul class="navbar-nav nav ml-auto w-100 justify-content-end" id="nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="drop2">
              ...
              <a class="dropdown-item" href="#">量化及程序化交易支持</a>
            </div>
          </li>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="drop3">
              <a class="dropdown-item" href="market_coverage_contract.php">产品及保证金</a>
              <a class="dropdown-item" href="calendar_holidays.php">交流假期日历</a>
              <a class="dropdown-item" href="calendar_futures.php">期货及预算产品最后交易日日历</a>
            </div>
          </li>
          <li class="nav-item dropdown">
           <a class="nav-link dropdown-toggle<?php if($a==5){?> active <?php } ?>" href="product_and_service/php" id="drop4" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <span class="menu-icon"><i onclick="myFunction(this)" class="fa fa-plus"></i></span>  
            产品及服务
            </a>
