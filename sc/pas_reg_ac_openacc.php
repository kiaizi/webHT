...
<?php
			...
			$sql = "select openaccount.*, openaccount_desc.name as name, openaccount_desc.detail, openaccount_desc.name2 as name2, openaccount_desc.detail2  from ".TB_OPENACCOUNT." as openaccount , ".TB_OPENACCOUNT_DESC." as openaccount_desc ";
			$sql .= " where ";
...
<!-- FAQ Icon -->
<a href="pas_faq.php"><img src="../images/faq.svg" alt="" class="faq-icon"></a>
