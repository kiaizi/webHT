  ...
  <div class="contaniner-fluid">
    <div class="title-bg">
      <div class="col-lg-12 ctm-width">
        ...
        <span class="other-title">期货和期权产品最后交易日</span></div>
    </div>
  </div>
...
?>	
          ...
          <div class="search_box">
		        <input type="text" class="input-form-control" name="calendar_search" id="calendar_search" placeholder="搜寻">
      ...
      <div class="col-lg-4 col-12 p-0">
        <table cellpadding="0" cellspacing="0" border="0">
          <tr>
            ...
            <td><h5 class="control-ccr-green">第一通知日</h5></td>
            <td width="10"></td>
            <td><span class="square-red"></span></td>
            <td><h5 class="control-ccr-red">最后交易日</h5></td>
            <td width="10"></td>
            <td><span class="square-yellow"></span></td>
            <td><h5 class="control-ccr-yellow">结算日</h5></td>
          </tr>
        </table>
      </div>
