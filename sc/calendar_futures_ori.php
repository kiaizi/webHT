<!doctype html>
  ...
  <html>
    <?php include('global/html_head_20201104_ori.php'); ?>
...
<body id="calendar-futures">
    ...
    <?php include('global/header_20201118_ori.php'); ?>
...
<div class="container theme-showcase" style="margin-top: 30px; margin-bottom: 30px; overflow-x: scroll;">
...
<?php include('global/footer_20210201_ori.php'); ?>
<script>
...
function thismonth_1(d) {
  
var md = d.substring(5);  
var dd = md.substring(1, md.lastIndexOf("_"));
  
  var rd = '.month-'+ (dd-2);
  
  var m_class = '.month-'+rd;
  
  alert(rd);
    $('td').find(m_class).removeClass('calendar-month');
  }
  
function remark_colors(d, e, f) 
{ 
  var xmlhttp = GetXmlHttpObject();
  var url="getclr_ori.php?date=" + d ;
  ...
  var url2="getitem_ori.php?date=" + d ;
...
<script type="text/tmpl" id="tmpl">
  ...
  <table class="calendar-table table table-condensed table-tight">
    ...
    <div id="active_m_1" onload="thismonth_1('{{: thedate.toDateCssClass() }}')"></div>
</script>
...
(function ($) {
  ...
  function calendar($el, options) {
    ...
    alert($m);
    $('.calendar-month').addClass("month_active");*/
