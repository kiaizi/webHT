...
<!-- Product & Service FAQ Banner and Title -->
  ...
  <div class="contaniner-fluid">
    <div class="title-bg">
      <div class="col-lg-12 ctm-width"><span class="square"></span><h3>期货服务常见问题</h3></div>
    </div>
  </div>
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        ...
                        <i class="fa fa-plus-circle" aria-hidden="true" onclick="myFunction(this)">
                          <div class="panel-text"><?php echo $faq_name ?></div>
                        </i>
                        </a>
                      </h4>
                    </div>
