    ...
    <!-- News PDF Page Content - Right Side -->
      <div class="col-lg-9 col-12 pt-lg-3 pl-lg-5">
        <div class="col-12 mt-2 mb-2">
          <span class="head_sction_link">业务覆盖 > <?php echo $trading_market_category_name; ?> > <span style="border-bottom: 2px solid #D93A16;"><?php echo $trading_market_name; ?></span></span>
        </div>
