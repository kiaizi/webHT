...
<style>
  ...
  /* Product and Service Software Page Content */
    ...
    /* software Title */
      ...
      #pas-software .nav-link.active span {
      ...
      <div class="pap-text">
          <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li class="nav-item">
              ...
              <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true"><div class="pap-img-01"><img src="../images/software-01.png" alt="" width="120px" class="si-01"></div><span>易盛交易系统</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false"><div class="pap-img-02"><img src="../images/software-02.png" alt="" width="100px" class="si-02"></div><span>ATP交易系统</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false"><div class="pap-img-03"><img src="../images/software-03.png" alt="" width="100px" class="si-03"></div><span>TT交易系统</span></a>
            </li>
          </ul>
      </div>
...
?>
 ...
 <div class="col-lg-12 col-6">
              <p class="md-qr-code"><?php echo $title; ?></p>
...
?>
        <div class="col-lg-4 col-6">
          ...
          <p class="mddf-red-text"><a href="<?php echo $file ; ?>" target="_blank">点击此处下载<span class="mddf-red-img"><img src="../images/download.svg" alt=""></span></a></p>
        </div>
