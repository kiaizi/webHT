        ...
        <ol class="carousel-indicators">
            ...
            if ($G_DB_CONNECT->affected_rows > 0) {
                ...
                while ($data = $G_DB_CONNECT->fetch_array($rows)) {
                    ...
                    <li data-target="#carouselExampleCaptions" data-slide-to="<?php echo $k; ?>" <?php if ($k == 0) {
                        echo 'class="active"';
                    } ?>></li>
...
//	$sql .= " and language_id='".CURRENT_LANG."' ";
                    ...
                    <div class="carousel-item <?php if ($k == 1) {
                        echo 'active';
                    } ?>">
                        ...
                        <div class="carousel-caption">
                            ...
                            <div class="row m-0">
                                ...
                                if ($home_banner_url != '') {
                                    ?>
                                    <a href="<?php echo $home_banner_url; ?>"
                                       target="<?php echo $home_banner_url_target; ?>">
                                        <div class="know_more_btn_1 m-2">了解更多</div>
                                    </a>
                                    <?php
                                }
                                ?>
                                ...
                                if ($home_banner_url2 != '') {
                                    ?>
                                    <a href="<?php echo $home_banner_url2; ?>"
                                       target="<?php echo $home_banner_url_target2; ?>">
                                        <div class="red_btn_1 m-2">现在开户</div>
                                    </a>
                                    <?php
                                }
                                ?>
                                ...
                                if ($img3 != '') {
                                    ...
                                    <a href="<?php echo $img3; ?>" target="_blank">
                                        <div class="know_more_btn_1 m-2">下载宣传手册</div>
                                    </a>
                                    <?php
                                }
                                ?>
                ...
                <div class="owl-carousel owl-theme" id="index_slider_news">
                    ...
                    while ($data = $G_DB_CONNECT->fetch_array($rows)) {
                        ...
                        <div class="item">
                            ...
                            <div class="idx_news_box_1 pb-3 mb-5"><a href="<?php echo $link; ?>"><img
                                            src="<?php echo $img; ?>" width="100%"></a>
                                <div class="idx_news_title_1"><?php echo $news_category_name; ?></div>
                                <div class="idx_news_content_1"><?php echo $news_name; ?>
                                    <br><br>
                                    <div class="know_more_btn_2 m-0 btn_link" href="<?php echo $link; ?>">了解更多&nbsp;&nbsp;<img
                                                src="../images/index/kw_more_arr.svg" height="15" class="img_mb_5">
                                    </div>
...
if ($G_DB_CONNECT->affected_rows > 0) {
    ...
    while ($data = $G_DB_CONNECT->fetch_array($rows2)) {
        ...
        <!--API量化的图片-->
        <div class="index_bg_2 d-md-block d-none api_part" style="background-image:url(<?php echo $img; ?>)">
        ...
        <div class="container" style="max-width: 90%;">
            ...
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        while ($data = $G_DB_CONNECT->fetch_array($rows)) {
                            ...
                            <div class="col-lg-3 col-6 p-lg-2 p-1">
                                <a href="<?php echo $home_promotion2_url; ?>"
                                   target="<?php echo $home_promotion2_url_target; ?>">
                ...
                <div class="col-12 text-center pb-5">
                    <div class="know_more_btn_2 btn_link" href="<?php echo $other_link; ?>"
                         target="<?php echo $other_link_target; ?>">了解更多&nbsp;&nbsp;<img
                                src="../images/index/kw_more_arr.svg" height="15" class="img_mb_5"></div>
                </div>
            </div>
        </div>
