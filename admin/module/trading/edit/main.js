$(document).ready(function(){ 
	...
	$("#dynamic_trading_photo").dynamicForm("#dynamic_trading_photo_footer", "#btn_add_trading_photo", ".btn_remove_trading_photo",'',true);
		$("#dynamic_trading_photo02").dynamicForm("#dynamic_trading_photo02_footer", "#btn_add_trading_photo02", ".btn_remove_trading_photo02",'',false);
		$("#dynamic_trading_photo03").dynamicForm("#dynamic_trading_photo03_footer", "#btn_add_trading_photo03", ".btn_remove_trading_photo03",'',false);
//$('.btn_edit_seo').show();
}); 
