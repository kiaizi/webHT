$(document).ready(function(){ 
	...
	$("#dynamic_trading2_photo").dynamicForm("#dynamic_trading2_photo_footer", "#btn_add_trading2_photo", ".btn_remove_trading2_photo",'',true);
		$("#dynamic_trading2_photo02").dynamicForm("#dynamic_trading2_photo02_footer", "#btn_add_trading2_photo02", ".btn_remove_trading2_photo02",'',false);
		$("#dynamic_trading2_photo03").dynamicForm("#dynamic_trading2_photo03_footer", "#btn_add_trading2_photo03", ".btn_remove_trading2_photo03",'',false);
//$('.btn_edit_seo').show();
}); 
