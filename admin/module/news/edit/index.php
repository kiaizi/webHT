<?php 
	...
	$sql = "select * from ".TB_NEWS." as news ";
	$sql .= " where ";
	$sql .= " id='".ID."' ";
...
// upload file
/////////////////////////////////////////////
$arr_news_photo_language_id = getRequestVar("news_photo_language_id",'');
$arr_news_photo_sort_order = getRequestVar("news_photo_sort_order",'');
$arr_news_photo_caption = getRequestVar("news_photo_caption",'');
$arr_news_photo_disabled = getRequestVar("news_photo_disabled",'');
$arr_news_photo_img_old_path = getRequestVar("news_photo_img_old_path",'');
$arr_news_photo_thumb_old_path = getRequestVar("news_photo_thumb_old_path",'');
if($arr_news_photo_disabled != '' && ID > 0){

	$news_id = ID;
	//$news_code = getDataName(TB_NEWS,"code",$news_id);
	$sql = "delete from ".TB_NEWS_PHOTO." where news_id='".$news_id."'";
	$G_DB_CONNECT->query($sql);

	for ($i=0; $i<count($arr_news_photo_disabled); $i++) {




		$news_photo_img_old_path = $arr_news_photo_img_old_path[$i];
		$news_photo_img = $news_photo_img_old_path;

		$dir = "upload/images/news/";
		$file_name = "news_photo_img";
		////////////////////////////////////////////////
		$tempFile = $_FILES[$file_name]['tmp_name'][$i];
		if($tempFile != ''){
			$targetPath = CURRENT_DOCUMENT_ROOT . $dir ;
			$ext = get_extension($_FILES[$file_name]['name'][$i]);
			//$new_file_name = $news_code."_".date("YmdHis")."_".getLastID(TB_NEWS_PHOTO).$ext;
			$new_file_name = date("YmdHis")."_".getLastID(TB_NEWS_PHOTO).$ext;
  			$targetFile =  str_replace('//','/',$targetPath) .$new_file_name ;
			move_uploaded_file($tempFile,$targetFile);
			$targetFile =$dir.$new_file_name;
			////////////////////////////////////////////////

			$news_photo_img  = $targetFile;
		...
		if($news_photo_img != '' ){
			////////////////////////////////////////////////
			$update_news_photo_data = array();
			$update_news_photo_data['language_id'] = $arr_news_photo_language_id[$i];
			$update_news_photo_data['img'] = $news_photo_img;
			$update_news_photo_data['thumb'] = $news_photo_thumb;
			$update_news_photo_data['caption'] = $arr_news_photo_caption[$i];
			$update_news_photo_data['sort_order'] = $arr_news_photo_sort_order[$i];
			$update_news_photo_data['disabled'] = $arr_news_photo_disabled[$i];
			$update_news_photo_data['news_id'] = $news_id;
			$update_news_photo_data['create_date'] = 'null';
			$update_news_photo_data['create_by'] = '';
			$update_news_photo_data['last_update_by'] = '';
			$G_DB_CONNECT->query_insert(TB_NEWS_PHOTO, $update_news_photo_data);
			////////////////////////////////////////////////
...
// upload file
/////////////////////////////////////////////
$arr_news_photo02_language_id = getRequestVar("news_photo02_language_id",'');
$arr_news_photo02_sort_order = getRequestVar("news_photo02_sort_order",'');
$arr_news_photo02_caption = getRequestVar("news_photo02_caption",'');
$arr_news_photo02_disabled = getRequestVar("news_photo02_disabled",'');
$arr_news_photo02_img_old_path = getRequestVar("news_photo02_img_old_path",'');
$arr_news_photo02_thumb_old_path = getRequestVar("news_photo02_thumb_old_path",'');
if($arr_news_photo02_disabled != '' && ID > 0){

	$news_id = ID;
	//$news_code = getDataName(TB_NEWS,"code",$news_id);
	$sql = "delete from ".TB_NEWS_PHOTO02." where news_id='".$news_id."'";
	$G_DB_CONNECT->query($sql);

	for ($i=0; $i<count($arr_news_photo02_disabled); $i++) {




		$news_photo02_img_old_path = $arr_news_photo02_img_old_path[$i];
		$news_photo02_img = $news_photo02_img_old_path;

		$dir = "upload/images/news/";
		$file_name = "news_photo02_img";
		////////////////////////////////////////////////
		$tempFile = $_FILES[$file_name]['tmp_name'][$i];
		if($tempFile != ''){
			$targetPath = CURRENT_DOCUMENT_ROOT . $dir ;
			$ext = get_extension($_FILES[$file_name]['name'][$i]);
			//$new_file_name = $news_code."_".date("YmdHis")."_".getLastID(TB_NEWS_PHOTO02).$ext;
			$new_file_name = date("YmdHis")."_".getLastID(TB_NEWS_PHOTO02).'_banner'.$ext;
  			$targetFile =  str_replace('//','/',$targetPath) .$new_file_name ;
			move_uploaded_file($tempFile,$targetFile);
			$targetFile =$dir.$new_file_name;
			////////////////////////////////////////////////

			$news_photo02_img  = $targetFile;
		...
		if($news_photo02_img != '' ){
			////////////////////////////////////////////////
			$update_news_photo02_data = array();
			$update_news_photo02_data['language_id'] = $arr_news_photo02_language_id[$i];
			$update_news_photo02_data['img'] = $news_photo02_img;
			$update_news_photo02_data['thumb'] = $news_photo02_thumb;
			$update_news_photo02_data['caption'] = $arr_news_photo02_caption[$i];
			$update_news_photo02_data['sort_order'] = $arr_news_photo02_sort_order[$i];
			$update_news_photo02_data['disabled'] = $arr_news_photo02_disabled[$i];
			$update_news_photo02_data['news_id'] = $news_id;
			$update_news_photo02_data['create_date'] = 'null';
			$update_news_photo02_data['create_by'] = '';
			$update_news_photo02_data['last_update_by'] = '';
			$G_DB_CONNECT->query_insert(TB_NEWS_PHOTO02, $update_news_photo02_data);
			////////////////////////////////////////////////
...
echo $G_DB_CONNECT->query_update_lang_content(TB_NEWS, $update_data_lang, "  news_id='".$update_data['id']."'   ");
*/
...
<?php 
   	...
   	printLangInputField("SEO H1","seo_h1",TB_NEWS,$edit_data['id'],"seo_h1",false,"input_seo_title","",false,'class="seo_row"');
...
<?php 
   	...
   	printLangInputField(TITLE_SEO_TITLE,"seo_title",TB_NEWS,$edit_data['id'],"seo_title",false,"input_seo_title","",false,'class="seo_row"');
...
printLangTextAreaNormal(TITLE_SEO_DESC,"seo_desc",TB_NEWS,$edit_data['id'],false,300,450,'','class="seo_row"');
?>
...
<tr>
	<td class="sign_must_enter"><div id="require"></div></td>
    <td class="title highlight">显示在首页</td>
...
<tr style="display:none">
    ...
    <?php
		if(ACTION == '1'){
			$edit_data['sort_order'] = getNextSortOrder(TB_NEWS,"");
		}
	?>
...
<tr style="display:none">
    ...
    <?php
		if(ACTION == '1'){
			//$edit_data['code'] = nextRecordcode(TB_NEWS,"","",4);
		}
	?>
...
<?php 
   ...
   $sql = "select news_category.*, news_category_desc.name as name from ".TB_NEWS_CATEGORY." as news_category , ".TB_NEWS_CATEGORY_DESC." as news_category_desc ";
	$sql .= " where ";
	$sql .= " news_category.id=news_category_desc.news_category_id ";
	$sql .= " and news_category_desc.language_id='".ADMIN_LANG_ID."' and disabled<>'".DISABLED_DELETE."' ";
	$sql .= " order by news_category.sort_order asc ";
				

	printCustomMenu('news_category_id', $sql,'name','0',$edit_data['news_category_id'],'','','','');
...
<?php 
   	...
   	printLangInputField(TITLE_TITLE,"name",TB_NEWS,$edit_data['id'],"name",true);
	//printLangTextAreaNormal('Brief',"detail2",TB_NEWS,$edit_data['id'],false,150,500,"");
	printLangTextArea(TITLE_DESC,"detail",TB_NEWS,$edit_data['id'],true,1300,850);
		

	//printLangTextArea('參考資料',"detail2",TB_NEWS,$edit_data['id'],true,500,850);
...
<?php
		...
		while($data2 = $G_DB_CONNECT->fetch_array($rows2)){
			...
			$sql .= " from ".TB_NEWS_TO_PRODUCT_TYPE;
			$sql .= " where ";
			$sql .= " news_id = '".ID."' ";
...
<?php
		...
		while($data2 = $G_DB_CONNECT->fetch_array($rows2)){
			...
			$sql .= " from ".TB_NEWS_TO_PRODUCT_CATEGORY;
			$sql .= " where ";
			$sql .= " news_id = '".ID."' ";
...
<?php
		...
		while($data2 = $G_DB_CONNECT->fetch_array($rows2)){
			...
			$sql .= " from ".TB_NEWS_TO_PRODUCT_CATEGORY2;
			$sql .= " where ";
			$sql .= " news_id = '".ID."' ";
...
<?php
		...
		while($data2 = $G_DB_CONNECT->fetch_array($rows2)){
			...
			$sql .= " from ".TB_NEWS_TO_PRODUCT_CATEGORY3;
			$sql .= " where ";
			$sql .= " news_id = '".ID."' ";
...
?>
 ...
 <?php //echo printLangTextArea(TITLE_CONTENT_IF_NO_LINK,"detail",TB_NEWS,$edit_data['id'],false,800); ?>  

   
<?php
// printLangTextAreaNormal(TITLE_TITLE,"name",TB_NEWS,$edit_data['id'],false,150,500,"");
?>
...
<?php
 //printLangTextAreaNormal(TITLE_ADDRESS,"address",TB_NEWS,$edit_data['id'],false,150,500,"");
?>
...
<table border="0" cellspacing="2" cellpadding="0"  id="table_text2">
  ...
  <tr>
     ...
     <br>
     <?php echo NOTICE_BEST_VIEW_PART_1; ?><?php echo TITLE_WIDTH; ?> : 552,<?php echo TITLE_HEIGHT; ?> : 420  <?php echo NOTICE_BEST_VIEW_PART_2; ?> 
     <br>
...
<?php
	$this_dynamic_area_id = "dynamic_news_photo";
?>
...
<input name="news_photo_img" id="news_photo_img"  value="" label="<?php echo TITLE_IMG;?>" type="file" class="input_file file_upload"/>
<input name="news_photo_img_old_path"  id="news_photo_img_old_path" value="" type="hidden"/>
    </td>
...
<?php 
	...
	printCustomMenu('news_photo_language_id', $sql,'name','0','','','','','');
?>
    
    </td>
    
<td style="display:none"><input name="news_photo_sort_order" id="news_photo_sort_order"  value="" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
...
<?php 
  ...
  $sql = "select status_disable.*, status_disable_desc.name as name from ".TB_STATUS_DISABLE." as status_disable , ".TB_STATUS_DISABLE_DESC." as status_disable_desc ";
	...
	printCustomMenu('news_photo_disabled', $sql,'name','0','','','','','');
?>
    ...
    <td style="width:250px;"><a href="#" style="display:none"  class="button btn_remove_news_photo"   ><span><?php echo BTN_REMOVE;?></span></a></td>
  </tr>
...
<?php
	...
	$i = 0;
  	$sql = "select * from ".TB_NEWS_PHOTO." as news_photo  ";
	...
	if($G_DB_CONNECT->affected_rows > 0){
			while($data = $G_DB_CONNECT->fetch_array($rows)){
				...
				$news_photo_img = "../".$data['img'];
				$arr_file_info = getImageInfo($news_photo_img,"thumb",$photo_width,$photo_height);
				$news_photo_img_thumb = $arr_file_info["src"];
...
<a href="<?php echo $news_photo_img; ?>" target="_blank"><img src="<?php echo $news_photo_img_thumb?>"  style="margin-bottom:10px;" align="middle" width="<?php echo $arr_file_info['width'] ?>" height="<?php echo $arr_file_info['height'] ?>"/></a>

</div>
</div>
<br>
<input name="news_photo_img[]" id="news_photo_img[]"  value="" label="<?php echo TITLE_PHOTO;?>" type="file" class="input_file img_upload"/>
<input name="news_photo_img_old_path[]"  id="news_photo_img_old_path[]" value="<?php echo $data['img']; ?>" type="hidden"/>
    </td>
...
<?php 
	...
	printCustomMenu('news_photo_language_id[]', $sql,'name','0',$data['language_id'],'','','','');
?>
   ...
   <td style="display:none"><input name="news_photo_sort_order[]" id="news_photo_sort_order[]"  value="<?php echo $data['sort_order']; ?>" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
...
<?php 
	...
	printCustomMenu('news_photo_disabled[]', $sql,'name','0',$data['disabled'],'','','','');
?>
...
?>
  ...
  <tr id="dynamic_news_photo_footer" style="display:none">
   <td colspan="5">&nbsp;</td>
  </tr>
...
<div style="float:left;"><a href="#" style="display:none" id="btn_add_news_photo" class="button btn_add_news_photo"  ><span><?php echo BTN_ADD_PHOTO;?></span></a></div>
...
<table border="0" cellspacing="2" cellpadding="0"  id="table_text2">
  ...
  <tr>
     ...
     <td style="vertical-align:top">Photo
     <br>
     <?php echo NOTICE_BEST_VIEW_PART_1; ?><?php echo TITLE_WIDTH; ?> : 1920,<?php echo TITLE_HEIGHT; ?> : 600  <?php echo NOTICE_BEST_VIEW_PART_2; ?> 
     <br>
     <?php echo NOTICE_FILE_FORMAT; ?> jpg, png, gif</td>
...
<?php
	$this_dynamic_area_id = "dynamic_news_photo02";
?>
...
<input name="news_photo02_img" id="news_photo02_img"  value="" label="<?php echo TITLE_IMG;?>" type="file" class="input_file file_upload"/>
<input name="news_photo02_img_old_path"  id="news_photo02_img_old_path" value="" type="hidden"/>
    </td>
...
<?php 
	...
	printCustomMenu('news_photo02_language_id', $sql,'name','0','','','','','');
?>
    
    </td>
    
<td     style="display:none"><input name="news_photo02_sort_order" id="news_photo02_sort_order"  value="" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
...
<?php 
  ...
  $sql = "select status_disable.*, status_disable_desc.name as name from ".TB_STATUS_DISABLE." as status_disable , ".TB_STATUS_DISABLE_DESC." as status_disable_desc ";
	...
	printCustomMenu('news_photo02_disabled', $sql,'name','0','','','','','');
?>
    ...
    <td style="width:250px;"><a href="#"     style="display:none"  class="button btn_remove_news_photo02"   ><span><?php echo BTN_REMOVE;?></span></a></td>
  </tr>
...
<?php
	...
	$i = 0;
  	$sql = "select * from ".TB_NEWS_PHOTO02." as news_photo02  ";
	$sql .= " where news_id='".ID."' ";
	$sql .= " order by sort_order asc ";
	$rows = $G_DB_CONNECT->query($sql);
	if($G_DB_CONNECT->affected_rows > 0){
			while($data = $G_DB_CONNECT->fetch_array($rows)){
				...
				$news_photo02_img = "../".$data['img'];
				$arr_file_info = getImageInfo($news_photo02_img,"thumb",$photo02_width,$photo02_height);
				$news_photo02_img_thumb = $arr_file_info["src"];
...
<a href="<?php echo $news_photo02_img; ?>" target="_blank"><img src="<?php echo $news_photo02_img_thumb?>"  style="margin-bottom:10px;" align="middle" width="<?php echo $arr_file_info['width'] ?>" height="<?php echo $arr_file_info['height'] ?>"/></a>

</div>
</div>
<br>
<input name="news_photo02_img[]" id="news_photo02_img[]"  value="" label="<?php echo TITLE_PHOTO02;?>" type="file" class="input_file img_upload"/>
<input name="news_photo02_img_old_path[]"  id="news_photo02_img_old_path[]" value="<?php echo $data['img']; ?>" type="hidden"/>
    </td>
...
<?php 
	...
	printCustomMenu('news_photo02_language_id[]', $sql,'name','0',$data['language_id'],'','','','');
?>
   ...
   <td     style="display:none"><input name="news_photo02_sort_order[]" id="news_photo02_sort_order[]"  value="<?php echo $data['sort_order']; ?>" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
...
<?php 
	...
	printCustomMenu('news_photo02_disabled[]', $sql,'name','0',$data['disabled'],'','','','');
?>
...
?>
  ...
  <tr id="dynamic_news_photo02_footer" style="display:none">
   <td colspan="5">&nbsp;</td>
  </tr>
...
<div style="float:left;"><a href="#"     style="display:none" id="btn_add_news_photo02" class="button btn_add_news_photo02"  ><span><?php echo BTN_ADD_PHOTO02;?></span></a></div>
