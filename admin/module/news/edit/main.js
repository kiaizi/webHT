$(document).ready(function(){ 
	...
	$("#dynamic_news_photo").dynamicForm("#dynamic_news_photo_footer", "#btn_add_news_photo", ".btn_remove_news_photo",'',false);
		$("#dynamic_news_photo02").dynamicForm("#dynamic_news_photo02_footer", "#btn_add_news_photo02", ".btn_remove_news_photo02",'',false);
