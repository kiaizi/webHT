...
<tr>
    ...
    <?php
		if(ACTION == '1'){
			$edit_data['sort_order'] = getNextSortOrder(TB_TRADING_MARKET," trading_market_category_id= 2");
		}
	?>
...
<?php 
	...
	printLangTextArea("产品特点".TITLE_DESC,"other_detail3",TB_TRADING_MARKET,$edit_data['id'],true,800,850);
...
<tr>
	<td class="sign_must_enter"></td>
	<td class="title vtop"  style="padding-top:12px;"><?php echo TITLE_IMG;?> (首页 )</td>
...
<input name="trading_market_photo02_img" id="trading_market_photo02_img"  value="" label="<?php echo TITLE_IMG;?>" type="file" class="input_file file_upload"/>
<input name="trading_market_photo02_img_old_path"  id="trading_market_photo02_img_old_path" value="" type="hidden"/>
    </td>
    
         <td  style="vertical-align:top;display:none">


<input name="trading_market_photo02_img2" id="trading_market_photo02_img2"  value="" label="<?php echo TITLE_IMG;?>" type="file" class="input_file file_upload"/>
<input name="trading_market_photo02_img2_old_path"  id="trading_market_photo02_img2_old_path" value="" type="hidden"/>
    </td>
...
<textarea style="width:300px;height:50px;" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_SC;?>" name="trading_market_photo02_title_sc" id="trading_market_photo02_title_sc"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "></textarea>
  <div style="clear:both;padding-top:5px;"></div>
  <textarea style="width:300px;height:50px;display:none" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_TC;?>" name="trading_market_photo02_title_tc" id="trading_market_photo02_title_tc"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "></textarea>
        <div style="clear:both;padding-top:5px;"></div>
    <textarea style="width:300px;height:50px;" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_EN;?>" name="trading_market_photo02_title_en" id="trading_market_photo02_title_en"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "></textarea>
...
<td  style="vertical-align:top;display:none"><input  style="width:50px;" name="trading_market_photo02_sort_order" id="trading_market_photo02_sort_order"  value="" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
...
?>
    ...
    <td style="width:250px; vertical-align:top;display:none"><a href="#"  class="button btn_remove_trading_market_photo02"   ><span><?php echo BTN_REMOVE;?></span></a></td>
  </tr>
...
<a href="<?php echo $trading_market_photo02_img; ?>" target="_blank"><img src="<?php echo $trading_market_photo02_img_thumb?>"  style="margin-bottom:10px;" align="middle" width="<?php echo $arr_file_info['width'] ?>" height="<?php echo $arr_file_info['height'] ?>"/></a>

</div>
</div>
<br>
<input name="trading_market_photo02_img[]" id="trading_market_photo02_img[]"  value="" label="<?php echo TITLE_PHOTO02;?>" type="file" class="input_file img_upload"/>
<input name="trading_market_photo02_img_old_path[]"  id="trading_market_photo02_img_old_path[]" value="<?php echo $data['img']; ?>" type="hidden"/>
    </td>
...
<div align="center">
<div style="width:<?php echo $photo02_width; ?>px; vertical-align:top">
<a href="<?php echo $trading_market_photo02_img; ?>" target="_blank">按此查看档案</a>

</div>
</div>
<br>
<input name="trading_market_photo02_img2[]" id="trading_market_photo02_img2[]"  value="" label="<?php echo TITLE_PHOTO02;?>" type="file" class="input_file img_upload"/>
<input name="trading_market_photo02_img2_old_path[]"  id="trading_market_photo02_img2_old_path[]" value="<?php echo $data['img2']; ?>" type="hidden"/>
    </td>
...
<textarea style="width:300px;height:50px;" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_SC;?>" name="trading_market_photo02_title_sc[]" id="trading_market_photo02_title_sc[]"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "><?php echo $data['title_sc']; ?></textarea>
  <div style="clear:both;padding-top:5px;"></div>
  <textarea style="width:300px;height:50px;display:none" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_TC;?>" name="trading_market_photo02_title_tc[]" id="trading_market_photo02_title_tc[]"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "><?php echo $data['title_tc']; ?></textarea>
        <div style="clear:both;padding-top:5px;"></div>
    <textarea style="width:300px;height:50px;" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_EN;?>" name="trading_market_photo02_title_en[]" id="trading_market_photo02_title_en[]"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "><?php echo $data['title_en']; ?></textarea>
...
?>
   ...
   <td  style="vertical-align:top;display:none"><input  style="width:50px;" name="trading_market_photo02_sort_order[]" id="trading_market_photo02_sort_order[]"  value="<?php echo $data['sort_order']; ?>" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
...
?>
  ...
  <tr id="dynamic_trading_market_photo02_footer" style="display:none">
   <td colspan="5">&nbsp;</td>
  </tr>
...
<div style="float:left;"><a href="#" id="btn_add_trading_market_photo02"  style="display:none" class="button btn_add_trading_market_photo02"  ><span><?php echo BTN_ADD_PHOTO;?></span></a></div>
...
<tr>
	<td class="sign_must_enter"></td>
	<td class="title vtop"  style="padding-top:12px;"><?php echo TITLE_IMG;?> (內文)</td>
<td style="padding-top:0px;">
...
<input name="trading_market_photo03_img" id="trading_market_photo03_img"  value="" label="<?php echo TITLE_IMG;?>" type="file" class="input_file file_upload"/>
<input name="trading_market_photo03_img_old_path"  id="trading_market_photo03_img_old_path" value="" type="hidden"/>
    </td>
    
         <td  style="vertical-align:top;display:none">


<input name="trading_market_photo03_img2" id="trading_market_photo03_img2"  value="" label="<?php echo TITLE_IMG;?>" type="file" class="input_file file_upload"/>
<input name="trading_market_photo03_img2_old_path"  id="trading_market_photo03_img2_old_path" value="" type="hidden"/>
    </td>
...
<textarea style="width:300px;height:50px;" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_SC;?>" name="trading_market_photo03_title_sc" id="trading_market_photo03_title_sc"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "></textarea>
  <div style="clear:both;padding-top:5px;"></div>
  <textarea style="width:300px;height:50px;display:none" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_TC;?>" name="trading_market_photo03_title_tc" id="trading_market_photo03_title_tc"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "></textarea>
        <div style="clear:both;padding-top:5px;"></div>
    <textarea style="width:300px;height:50px;" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_EN;?>" name="trading_market_photo03_title_en" id="trading_market_photo03_title_en"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "></textarea>
...
<td  style="vertical-align:top;"><input  style="width:50px;" name="trading_market_photo03_sort_order" id="trading_market_photo03_sort_order"  value="" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
...
?>
    ...
    <td style="width:250px; vertical-align:top;"><a href="#"  class="button btn_remove_trading_market_photo03"   ><span><?php echo BTN_REMOVE;?></span></a></td>
  </tr>
...
<a href="<?php echo $trading_market_photo03_img; ?>" target="_blank"><img src="<?php echo $trading_market_photo03_img_thumb?>"  style="margin-bottom:10px;" align="middle" width="<?php echo $arr_file_info['width'] ?>" height="<?php echo $arr_file_info['height'] ?>"/></a>

</div>
</div>
<br>
<input name="trading_market_photo03_img[]" id="trading_market_photo03_img[]"  value="" label="<?php echo TITLE_PHOTO03;?>" type="file" class="input_file img_upload"/>
<input name="trading_market_photo03_img_old_path[]"  id="trading_market_photo03_img_old_path[]" value="<?php echo $data['img']; ?>" type="hidden"/>
    </td>
...
<div align="center">
<div style="width:<?php echo $photo03_width; ?>px; vertical-align:top">
<a href="<?php echo $trading_market_photo03_img; ?>" target="_blank">按此查看档案</a>

</div>
</div>
<br>
<input name="trading_market_photo03_img2[]" id="trading_market_photo03_img2[]"  value="" label="<?php echo TITLE_PHOTO03;?>" type="file" class="input_file img_upload"/>
<input name="trading_market_photo03_img2_old_path[]"  id="trading_market_photo03_img2_old_path[]" value="<?php echo $data['img2']; ?>" type="hidden"/>
    </td>
...
<textarea style="width:300px;height:50px;" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_SC;?>" name="trading_market_photo03_title_sc[]" id="trading_market_photo03_title_sc[]"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "><?php echo $data['title_sc']; ?></textarea>
  <div style="clear:both;padding-top:5px;"></div>
  <textarea style="width:300px;height:50px;display:none" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_TC;?>" name="trading_market_photo03_title_tc[]" id="trading_market_photo03_title_tc[]"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "><?php echo $data['title_tc']; ?></textarea>
        <div style="clear:both;padding-top:5px;"></div>
    <textarea style="width:300px;height:50px;" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_EN;?>" name="trading_market_photo03_title_en[]" id="trading_market_photo03_title_en[]"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "><?php echo $data['title_en']; ?></textarea>
...
?>
   ...
   <td  style="vertical-align:top"><input  style="width:50px;" name="trading_market_photo03_sort_order[]" id="trading_market_photo03_sort_order[]"  value="<?php echo $data['sort_order']; ?>" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
...
?>
  ...
  <tr id="dynamic_trading_market_photo03_footer" style="display:none">
   <td colspan="5">&nbsp;</td>
  </tr>
...
<div style="float:left;"><a href="#" id="btn_add_trading_market_photo03"  class="button btn_add_trading_market_photo03"  ><span><?php echo BTN_ADD_PHOTO;?></span></a></div>
...
<input name="trading_market_photo_img" id="trading_market_photo_img"  value="" label="<?php echo TITLE_IMG;?>" type="file" class="input_file file_upload"/>
<input name="trading_market_photo_img_old_path"  id="trading_market_photo_img_old_path" value="" type="hidden"/>
    </td>
    
         <td  style="vertical-align:top">


<input name="trading_market_photo_img2" id="trading_market_photo_img2"  value="" label="<?php echo TITLE_IMG;?>" type="file" class="input_file file_upload"/>
<input name="trading_market_photo_img2_old_path"  id="trading_market_photo_img2_old_path" value="" type="hidden"/>
    </td>
...
<textarea style="width:300px;height:50px;" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_SC;?>" name="trading_market_photo_title_sc" id="trading_market_photo_title_sc"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "></textarea>
  <div style="clear:both;padding-top:5px;"></div>
  <textarea style="width:300px;height:50px;display:none" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_TC;?>" name="trading_market_photo_title_tc" id="trading_market_photo_title_tc"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "></textarea>
        <div style="clear:both;padding-top:5px;"></div>
    <textarea style="width:300px;height:50px;" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_EN;?>" name="trading_market_photo_title_en" id="trading_market_photo_title_en"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "></textarea>
...
<td  style="vertical-align:top"><input  style="width:50px;" name="trading_market_photo_sort_order" id="trading_market_photo_sort_order"  value="" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
...
?>
    ...
    <td style="width:250px; vertical-align:top"><a href="#"  class="button btn_remove_trading_market_photo"   ><span><?php echo BTN_REMOVE;?></span></a></td>
  </tr>
...
<a href="<?php echo $trading_market_photo_img; ?>" target="_blank"><img src="<?php echo $trading_market_photo_img_thumb?>"  style="margin-bottom:10px;" align="middle" width="<?php echo $arr_file_info['width'] ?>" height="<?php echo $arr_file_info['height'] ?>"/></a>

</div>
</div>
<br>
<input name="trading_market_photo_img[]" id="trading_market_photo_img[]"  value="" label="<?php echo TITLE_PHOTO;?>" type="file" class="input_file img_upload"/>
<input name="trading_market_photo_img_old_path[]"  id="trading_market_photo_img_old_path[]" value="<?php echo $data['img']; ?>" type="hidden"/>
    </td>
...
<div align="center">
<div style="width:<?php echo $photo_width; ?>px; vertical-align:top">
<a href="<?php echo $trading_market_photo_img; ?>" target="_blank">按此查看档案</a>

</div>
</div>
<br>
<input name="trading_market_photo_img2[]" id="trading_market_photo_img2[]"  value="" label="<?php echo TITLE_PHOTO;?>" type="file" class="input_file img_upload"/>
<input name="trading_market_photo_img2_old_path[]"  id="trading_market_photo_img2_old_path[]" value="<?php echo $data['img2']; ?>" type="hidden"/>
    </td>
...
<textarea style="width:300px;height:50px;" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_SC;?>" name="trading_market_photo_title_sc[]" id="trading_market_photo_title_sc[]"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "><?php echo $data['title_sc']; ?></textarea>
  <div style="clear:both;padding-top:5px;"></div>
  <textarea style="width:300px;height:50px;display:none" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_TC;?>" name="trading_market_photo_title_tc[]" id="trading_market_photo_title_tc[]"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "><?php echo $data['title_tc']; ?></textarea>
        <div style="clear:both;padding-top:5px;"></div>
    <textarea style="width:300px;height:50px;" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_EN;?>" name="trading_market_photo_title_en[]" id="trading_market_photo_title_en[]"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "><?php echo $data['title_en']; ?></textarea>
...
?>
   ...
   <td  style="vertical-align:top"><input  style="width:50px;" name="trading_market_photo_sort_order[]" id="trading_market_photo_sort_order[]"  value="<?php echo $data['sort_order']; ?>" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
...
?>
  ...
  <tr id="dynamic_trading_market_photo_footer" style="display:none">
   <td colspan="5">&nbsp;</td>
  </tr>
...
<div style="float:left;"><a href="#" id="btn_add_trading_market_photo" class="button btn_add_trading_market_photo"  ><span><?php echo BTN_ADD_PHOTO;?></span></a></div>
