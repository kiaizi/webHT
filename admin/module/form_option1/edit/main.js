$(document).ready(function(){ 
	...
	$("#dynamic_form_option1_photo").dynamicForm("#dynamic_form_option1_photo_footer", "#btn_add_form_option1_photo", ".btn_remove_form_option1_photo",'',true);
		$("#dynamic_form_option1_photo02").dynamicForm("#dynamic_form_option1_photo02_footer", "#btn_add_form_option1_photo02", ".btn_remove_form_option1_photo02",'',false);
		$("#dynamic_form_option1_photo03").dynamicForm("#dynamic_form_option1_photo03_footer", "#btn_add_form_option1_photo03", ".btn_remove_form_option1_photo03",'',false);
//$('.btn_edit_seo').show();
}); 
