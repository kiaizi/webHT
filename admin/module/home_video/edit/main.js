$(document).ready(function(){ 
	...
	$("#dynamic_video_photo").dynamicForm("#dynamic_video_photo_footer", "#btn_add_video_photo", ".btn_remove_video_photo",'',false);
	
		
	$("#dynamic_video_photo02").dynamicForm("#dynamic_video_photo02_footer", "#btn_add_video_photo02", ".btn_remove_video_photo02",'',true);
