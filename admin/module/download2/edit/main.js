$(document).ready(function(){ 
	...
	$("#dynamic_download_photo").dynamicForm("#dynamic_download_photo_footer", "#btn_add_download_photo", ".btn_remove_download_photo",'',true);
		$("#dynamic_download_photo02").dynamicForm("#dynamic_download_photo02_footer", "#btn_add_download_photo02", ".btn_remove_download_photo02",'',true);
$('.btn_edit_seo').show();
}); 
