$(document).ready(function(){ 
	...
	$("#dynamic_blog_photo").dynamicForm("#dynamic_blog_photo_footer", "#btn_add_blog_photo", ".btn_remove_blog_photo",'',false);
		$("#dynamic_blog_photo02").dynamicForm("#dynamic_blog_photo02_footer", "#btn_add_blog_photo02", ".btn_remove_blog_photo02",'',true);
$('.btn_edit_seo').show();
}); 
