$(document).ready(function(){ 
	...
	$("#dynamic_home_promotion_photo").dynamicForm("#dynamic_home_promotion_photo_footer", "#btn_add_home_promotion_photo", ".btn_remove_home_promotion_photo",'',false);
	$("#dynamic_home_promotion_photo02").dynamicForm("#dynamic_home_promotion_photo02_footer", "#btn_add_home_promotion_photo02", ".btn_remove_home_promotion_photo02",'',false);
