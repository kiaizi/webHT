...
<?php 
   ...
   $sql = "select trading_support_category.*, trading_support_category_desc.name as name from ".TB_TRADING_SUPPORT_CATEGORY." as trading_support_category , ".TB_TRADING_SUPPORT_CATEGORY_DESC." as trading_support_category_desc ";
	...
	$sql .= " and trading_support_category_desc.language_id='".ADMIN_LANG_ID."' ";
	$sql .= " group by trading_support_category.id  ";
	$sql .= " order by trading_support_category.sort_order asc ";
				

	printCustomMenu('search_trading_support_category_id', $sql,'name','',$_REQUEST['search_trading_support_category_id'],'',TITLE_ALL,'-1','');
