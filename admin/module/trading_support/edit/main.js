$(document).ready(function(){ 
	...
	$("#dynamic_trading_support_photo").dynamicForm("#dynamic_trading_support_photo_footer", "#btn_add_trading_support_photo", ".btn_remove_trading_support_photo",'',true);
		$("#dynamic_trading_support_photo02").dynamicForm("#dynamic_trading_support_photo02_footer", "#btn_add_trading_support_photo02", ".btn_remove_trading_support_photo02",'',true);
