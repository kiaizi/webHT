...
$(".btn_edit_seo").show();
	...
	$("#dynamic_banner_photo").dynamicForm("#dynamic_banner_photo_footer", "#btn_add_banner_photo", ".btn_remove_banner_photo",'',false);
	$("#dynamic_banner_photo02").dynamicForm("#dynamic_banner_photo02_footer", "#btn_add_banner_photo02", ".btn_remove_banner_photo02",'',false);
