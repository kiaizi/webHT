$(document).ready(function(){ 
	...
	setTimeout(function(){ $('#fixed_action_button_area').show(); }, 6000);
	...
	$("#dynamic_trading_market_photo").dynamicForm("#dynamic_trading_market_photo_footer", "#btn_add_trading_market_photo", ".btn_remove_trading_market_photo",'',true);
		$("#dynamic_trading_market_photo02").dynamicForm("#dynamic_trading_market_photo02_footer", "#btn_add_trading_market_photo02", ".btn_remove_trading_market_photo02",'',false);
			$("#dynamic_trading_market_photo03").dynamicForm("#dynamic_trading_market_photo03_footer", "#btn_add_trading_market_photo03", ".btn_remove_trading_market_photo03",'',true);
