<?php
//<!-- 后台管理-业务覆盖-中国市场-ajax更新的时候调整 editFiles-Henry-202301  -->
if (count($_POST) > 0) {
    $this_dir_path = "../../../";
    ...
    if ($_SESSION['already_login']) {
        ...
        */
        ...
        if($update_data['remark'] == 'ibBusi'){
            $trading_market_category_id = $update_data['trading_market_category_id'] = 4;
        } else {
            $trading_market_category_id = $update_data['trading_market_category_id'] = 1;
        }
//        $trading_market_category_id = $update_data['trading_market_category_id'];
