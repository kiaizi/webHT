$(document).ready(function(){ 
	...
	$("#dynamic_research_photo").dynamicForm("#dynamic_research_photo_footer", "#btn_add_research_photo", ".btn_remove_research_photo",'',false);
		$("#dynamic_research_pdf").dynamicForm("#dynamic_research_pdf_footer", "#btn_add_research_pdf", ".btn_remove_research_pdf",'',false);
