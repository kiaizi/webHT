<?php 
	...
	$sql = "select * from ".TB_RESEARCH." as research ";
	$sql .= " where ";
	$sql .= " id='".ID."' ";
...
// upload file
/////////////////////////////////////////////
$arr_research_photo_language_id = getRequestVar("research_photo_language_id",'');
$arr_research_photo_sort_order = getRequestVar("research_photo_sort_order",'');
$arr_research_photo_caption = getRequestVar("research_photo_caption",'');
$arr_research_photo_disabled = getRequestVar("research_photo_disabled",'');
$arr_research_photo_img_old_path = getRequestVar("research_photo_img_old_path",'');
$arr_research_photo_thumb_old_path = getRequestVar("research_photo_thumb_old_path",'');
if($arr_research_photo_disabled != '' && ID > 0){

	$research_id = ID;
	//$research_code = getDataName(TB_RESEARCH,"code",$research_id);
	$sql = "delete from ".TB_RESEARCH_PHOTO." where research_id='".$research_id."'";
	$G_DB_CONNECT->query($sql);

	for ($i=0; $i<count($arr_research_photo_disabled); $i++) {




		$research_photo_img_old_path = $arr_research_photo_img_old_path[$i];
		$research_photo_img = $research_photo_img_old_path;

		$dir = "upload/images/research/";
		$file_name = "research_photo_img";
		////////////////////////////////////////////////
		$tempFile = $_FILES[$file_name]['tmp_name'][$i];
		if($tempFile != ''){
			$targetPath = CURRENT_DOCUMENT_ROOT . $dir ;
			$ext = get_extension($_FILES[$file_name]['name'][$i]);
			//$new_file_name = $research_code."_".date("YmdHis")."_".getLastID(TB_RESEARCH_PHOTO).$ext;
			$new_file_name = date("YmdHis")."_".getLastID(TB_RESEARCH_PHOTO).$ext;
  			$targetFile =  str_replace('//','/',$targetPath) .$new_file_name ;
			move_uploaded_file($tempFile,$targetFile);
			$targetFile =$dir.$new_file_name;
			////////////////////////////////////////////////

			$research_photo_img  = $targetFile;
		...
		if($research_photo_img != '' ){
			////////////////////////////////////////////////
			$update_research_photo_data = array();
			$update_research_photo_data['language_id'] = $arr_research_photo_language_id[$i];
			$update_research_photo_data['img'] = $research_photo_img;
			$update_research_photo_data['thumb'] = $research_photo_thumb;
			$update_research_photo_data['caption'] = $arr_research_photo_caption[$i];
			$update_research_photo_data['sort_order'] = $arr_research_photo_sort_order[$i];
			$update_research_photo_data['disabled'] = $arr_research_photo_disabled[$i];
			$update_research_photo_data['research_id'] = $research_id;
			$update_research_photo_data['create_date'] = 'null';
			$update_research_photo_data['create_by'] = '';
			$update_research_photo_data['last_update_by'] = '';
			$G_DB_CONNECT->query_insert(TB_RESEARCH_PHOTO, $update_research_photo_data);
			////////////////////////////////////////////////
...
// upload file
/////////////////////////////////////////////
$arr_research_pdf_language_id = getRequestVar("research_pdf_language_id",'');
$arr_research_pdf_sort_order = getRequestVar("research_pdf_sort_order",'');
$arr_research_pdf_caption = getRequestVar("research_pdf_caption",'');
$arr_research_pdf_disabled = getRequestVar("research_pdf_disabled",'');
$arr_research_pdf_img_old_path = getRequestVar("research_pdf_img_old_path",'');
$arr_research_pdf_thumb_old_path = getRequestVar("research_pdf_thumb_old_path",'');
if($arr_research_pdf_disabled != '' && ID > 0){

	$research_id = ID;
	//$research_code = getDataName(TB_RESEARCH,"code",$research_id);
	$sql = "delete from ".TB_RESEARCH_PDF." where research_id='".$research_id."'";
	$G_DB_CONNECT->query($sql);

	for ($i=0; $i<count($arr_research_pdf_disabled); $i++) {




		$research_pdf_img_old_path = $arr_research_pdf_img_old_path[$i];
		$research_pdf_img = $research_pdf_img_old_path;

		$dir = "upload/files/research/";
		$file_name = "research_pdf_img";
		////////////////////////////////////////////////
		$tempFile = $_FILES[$file_name]['tmp_name'][$i];
		if($tempFile != ''){
			$targetPath = CURRENT_DOCUMENT_ROOT . $dir ;
			$ext = get_extension($_FILES[$file_name]['name'][$i]);
			//$new_file_name = $research_code."_".date("YmdHis")."_".getLastID(TB_RESEARCH_PDF).$ext;
			$new_file_name = date("YmdHis")."_".getLastID(TB_RESEARCH_PDF).$ext;
  			$targetFile =  str_replace('//','/',$targetPath) .$new_file_name ;
			move_uploaded_file($tempFile,$targetFile);
			$targetFile =$dir.$new_file_name;
			////////////////////////////////////////////////

			$research_pdf_img  = $targetFile;
		...
		if($research_pdf_img != '' ){
			////////////////////////////////////////////////
			$update_research_pdf_data = array();
			$update_research_pdf_data['language_id'] = $arr_research_pdf_language_id[$i];
			$update_research_pdf_data['img'] = $research_pdf_img;
			//$update_research_pdf_data['thumb'] = $research_pdf_thumb;
			$update_research_pdf_data['caption'] = $arr_research_pdf_caption[$i];
			$update_research_pdf_data['sort_order'] = $arr_research_pdf_sort_order[$i];
			$update_research_pdf_data['disabled'] = $arr_research_pdf_disabled[$i];
			$update_research_pdf_data['research_id'] = $research_id;
			$update_research_pdf_data['create_date'] = 'null';
			$update_research_pdf_data['create_by'] = '';
			$update_research_pdf_data['last_update_by'] = '';
			$G_DB_CONNECT->query_insert(TB_RESEARCH_PDF, $update_research_pdf_data);
			////////////////////////////////////////////////
...
echo $G_DB_CONNECT->query_update_lang_content(TB_RESEARCH, $update_data_lang, "  research_id='".$update_data['id']."'   ");
*/
...
<?php 
   	...
   	printLangInputField("SEO H1","seo_h1",TB_RESEARCH,$edit_data['id'],"seo_h1",false,"input_seo_title","",false,'class="seo_row"');
...
<?php 
   	...
   	printLangInputField(TITLE_SEO_TITLE,"seo_title",TB_RESEARCH,$edit_data['id'],"seo_title",false,"input_seo_title","",false,'class="seo_row"');
...
printLangTextAreaNormal(TITLE_SEO_DESC,"seo_desc",TB_RESEARCH,$edit_data['id'],false,300,450,'','class="seo_row"');
?>
...
<tr style="display:none">
    ...
    <?php
		if(ACTION == '1'){
			$edit_data['sort_order'] = getNextSortOrder(TB_RESEARCH,"");
		}
	?>
...
<tr style="display:none">
    ...
    <?php
		if(ACTION == '1'){
			//$edit_data['code'] = nextRecordcode(TB_RESEARCH,"","",4);
		}
	?>
...
<?php 
   ...
   $sql = "select research_category.*, research_category_desc.name as name from ".TB_RESEARCH_CATEGORY." as research_category , ".TB_RESEARCH_CATEGORY_DESC." as research_category_desc ";
	...
	$sql .= " and research_category_desc.language_id='".ADMIN_LANG_ID."' and disabled<>'".DISABLED_DELETE."' ";
	$sql .= " order by research_category.sort_order asc ";
				

	printCustomMenu('research_category_id', $sql,'name','0',$edit_data['research_category_id'],'','','','');
...
<?php 
   	...
   	printLangInputField(TITLE_TITLE,"name",TB_RESEARCH,$edit_data['id'],"name",true);
	//printLangTextAreaNormal('Brief',"detail2",TB_RESEARCH,$edit_data['id'],false,150,500,"");
	//printLangTextArea(TITLE_DESC,"detail",TB_RESEARCH,$edit_data['id'],true,1300,850);
		

	//printLangTextArea('參考資料',"detail2",TB_RESEARCH,$edit_data['id'],true,500,850);
...
<?php
		...
		while($data2 = $G_DB_CONNECT->fetch_array($rows2)){
			...
			$sql .= " from ".TB_RESEARCH_TO_PRODUCT_TYPE;
			$sql .= " where ";
			$sql .= " research_id = '".ID."' ";
...
<?php
		...
		while($data2 = $G_DB_CONNECT->fetch_array($rows2)){
			...
			$sql .= " from ".TB_RESEARCH_TO_PRODUCT;
			$sql .= " where ";
			$sql .= " research_id = '".ID."' ";
...
<?php
		...
		while($data2 = $G_DB_CONNECT->fetch_array($rows2)){
			...
			$sql .= " from ".TB_RESEARCH_TO_PRODUCT_CATEGORY;
			$sql .= " where ";
			$sql .= " research_id = '".ID."' ";
...
<?php
		...
		while($data2 = $G_DB_CONNECT->fetch_array($rows2)){
			...
			$sql .= " from ".TB_RESEARCH_TO_PRODUCT_CATEGORY2;
			$sql .= " where ";
			$sql .= " research_id = '".ID."' ";
...
<?php
		...
		while($data2 = $G_DB_CONNECT->fetch_array($rows2)){
			...
			$sql .= " from ".TB_RESEARCH_TO_PRODUCT_CATEGORY3;
			$sql .= " where ";
			$sql .= " research_id = '".ID."' ";
...
?>
 ...
 <?php //echo printLangTextArea(TITLE_CONTENT_IF_NO_LINK,"detail",TB_RESEARCH,$edit_data['id'],false,800); ?>  

   
<?php
// printLangTextAreaNormal(TITLE_TITLE,"name",TB_RESEARCH,$edit_data['id'],false,150,500,"");
?>
...
<?php
 //printLangTextAreaNormal(TITLE_ADDRESS,"address",TB_RESEARCH,$edit_data['id'],false,150,500,"");
?>
...
<?php
	$this_dynamic_area_id = "dynamic_research_photo";
?>
...
<input name="research_photo_img" id="research_photo_img"  value="" label="<?php echo TITLE_IMG;?>" type="file" class="input_file file_upload"/>
<input name="research_photo_img_old_path"  id="research_photo_img_old_path" value="" type="hidden"/>
    </td>
...
<?php 
	...
	printCustomMenu('research_photo_language_id', $sql,'name','0','','','','','');
?>
    
    </td>
    
<td><input name="research_photo_sort_order" id="research_photo_sort_order"  value="" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
...
<?php 
  ...
  $sql = "select status_disable.*, status_disable_desc.name as name from ".TB_STATUS_DISABLE." as status_disable , ".TB_STATUS_DISABLE_DESC." as status_disable_desc ";
	...
	printCustomMenu('research_photo_disabled', $sql,'name','0','','','','','');
?>
    ...
    <td style="width:250px;"><a href="#"  class="button btn_remove_research_photo"   ><span><?php echo BTN_REMOVE;?></span></a></td>
  </tr>
...
<?php
	...
	$i = 0;
  	$sql = "select * from ".TB_RESEARCH_PHOTO." as research_photo  ";
	$sql .= " where research_id='".ID."' ";
	...
	if($G_DB_CONNECT->affected_rows > 0){
			while($data = $G_DB_CONNECT->fetch_array($rows)){
				...
				$research_photo_img = "../".$data['img'];
				$arr_file_info = getImageInfo($research_photo_img,"thumb",$photo_width,$photo_height);
				$research_photo_img_thumb = $arr_file_info["src"];
...
<a href="<?php echo $research_photo_img; ?>" target="_blank"><img src="<?php echo $research_photo_img_thumb?>"  style="margin-bottom:10px;" align="middle" width="<?php echo $arr_file_info['width'] ?>" height="<?php echo $arr_file_info['height'] ?>"/></a>

</div>
</div>
<br>
<input name="research_photo_img[]" id="research_photo_img[]"  value="" label="<?php echo TITLE_PHOTO;?>" type="file" class="input_file img_upload"/>
<input name="research_photo_img_old_path[]"  id="research_photo_img_old_path[]" value="<?php echo $data['img']; ?>" type="hidden"/>
    </td>
...
<?php 
	...
	printCustomMenu('research_photo_language_id[]', $sql,'name','0',$data['language_id'],'','','','');
?>
   ...
   <td><input name="research_photo_sort_order[]" id="research_photo_sort_order[]"  value="<?php echo $data['sort_order']; ?>" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
...
<?php 
	...
	printCustomMenu('research_photo_disabled[]', $sql,'name','0',$data['disabled'],'','','','');
?>
...
?>
  ...
  <tr id="dynamic_research_photo_footer" style="display:none">
   <td colspan="5">&nbsp;</td>
  </tr>
...
<div style="float:left;"><a href="#" id="btn_add_research_photo" class="button btn_add_research_photo"  ><span><?php echo BTN_ADD_PHOTO;?></span></a></div>
...
<?php
	$this_dynamic_area_id = "dynamic_research_pdf";
?>
...
<input name="research_pdf_img" id="research_pdf_img"  value="" label="<?php echo TITLE_IMG;?>" type="file" class="input_file file_upload"/>
<input name="research_pdf_img_old_path"  id="research_pdf_img_old_path" value="" type="hidden"/>
    </td>
...
<?php 
	...
	printCustomMenu('research_pdf_language_id', $sql,'name','0','','','','','');
?>
    
    </td>
    
<td style="display:none"><input name="research_pdf_sort_order" id="research_pdf_sort_order"  value="" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
...
<?php 
  ...
  $sql = "select status_disable.*, status_disable_desc.name as name from ".TB_STATUS_DISABLE." as status_disable , ".TB_STATUS_DISABLE_DESC." as status_disable_desc ";
	...
	printCustomMenu('research_pdf_disabled', $sql,'name','0','','','','','');
?>
    ...
    <td style="width:250px;"><a href="#" style="display:none"  class="button btn_remove_research_pdf"   ><span><?php echo BTN_REMOVE;?></span></a></td>
  </tr>
...
<?php
	...
	$i = 0;
  	$sql = "select * from ".TB_RESEARCH_PDF." as research_pdf  ";
	$sql .= " where research_id='".ID."' ";
	$sql .= " order by sort_order asc ";
	$rows = $G_DB_CONNECT->query($sql);
	if($G_DB_CONNECT->affected_rows > 0){
			while($data = $G_DB_CONNECT->fetch_array($rows)){
				...
				$research_pdf_img = "../".$data['img'];
				$arr_file_info = getImageInfo($research_pdf_img,"thumb",$pdf_width,$pdf_height);
				$research_pdf_img_thumb = $arr_file_info["src"];
...
<a href="<?php echo $research_pdf_img; ?>" target="_blank">按此查看档案</a>

</div>
</div>
<br>
<input name="research_pdf_img[]" id="research_pdf_img[]"  value="" label="<?php echo TITLE_PDF;?>" type="file" class="input_file img_upload"/>
<input name="research_pdf_img_old_path[]"  id="research_pdf_img_old_path[]" value="<?php echo $data['img']; ?>" type="hidden"/>
    </td>
...
<?php 
	...
	printCustomMenu('research_pdf_language_id[]', $sql,'name','0',$data['language_id'],'','','','');
?>
   ...
   <td style="display:none"><input name="research_pdf_sort_order[]" id="research_pdf_sort_order[]"  value="<?php echo $data['sort_order']; ?>" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
...
<?php 
	...
	printCustomMenu('research_pdf_disabled[]', $sql,'name','0',$data['disabled'],'','','','');
?>
...
?>
  ...
  <tr id="dynamic_research_pdf_footer" style="display:none">
   <td colspan="5">&nbsp;</td>
  </tr>
...
<div style="float:left;"><a href="#" style="display:none" id="btn_add_research_pdf" class="button btn_add_research_pdf"  ><span><?php echo BTN_ADD_PDF;?></span></a></div>
