$(document).ready(function(){ 
	...
	$("#dynamic_trading_hoilday_photo").dynamicForm("#dynamic_trading_hoilday_photo_footer", "#btn_add_trading_hoilday_photo", ".btn_remove_trading_hoilday_photo",'',true);
		$("#dynamic_trading_hoilday_photo02").dynamicForm("#dynamic_trading_hoilday_photo02_footer", "#btn_add_trading_hoilday_photo02", ".btn_remove_trading_hoilday_photo02",'',true);
