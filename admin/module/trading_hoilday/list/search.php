...
<?php 
   ...
   $sql = "select trading_hoilday_category.*, trading_hoilday_category_desc.name as name from ".TB_TRADING_HOILDAY_CATEGORY." as trading_hoilday_category , ".TB_TRADING_HOILDAY_CATEGORY_DESC." as trading_hoilday_category_desc ";
	...
	$sql .= " and trading_hoilday_category_desc.language_id='".ADMIN_LANG_ID."' ";
	$sql .= " group by trading_hoilday_category.id  ";
	$sql .= " order by trading_hoilday_category.sort_order asc ";
				

	printCustomMenu('search_trading_hoilday_category_id', $sql,'name','',$_REQUEST['search_trading_hoilday_category_id'],'',TITLE_ALL,'-1','');
