...
<?php 
   ...
   $sql = "select openaccount_category.*, openaccount_category_desc.name as name from ".TB_OPENACCOUNT_CATEGORY." as openaccount_category , ".TB_OPENACCOUNT_CATEGORY_DESC." as openaccount_category_desc ";
	...
	$sql .= " and openaccount_category_desc.language_id='".ADMIN_LANG_ID."' ";
	$sql .= " group by openaccount_category.id  ";
	$sql .= " order by openaccount_category.sort_order asc ";
				

	printCustomMenu('search_openaccount_category_id', $sql,'name','',$_REQUEST['search_openaccount_category_id'],'',TITLE_ALL,'-1','');
