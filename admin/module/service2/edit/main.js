$(document).ready(function(){ 
	...
	$("#dynamic_service2_photo").dynamicForm("#dynamic_service2_photo_footer", "#btn_add_service2_photo", ".btn_remove_service2_photo",'',false);
	$("#dynamic_service2_photo02").dynamicForm("#dynamic_service2_photo02_footer", "#btn_add_service2_photo02", ".btn_remove_service2_photo02",'',true);
		$("#dynamic_service2_photo03").dynamicForm("#dynamic_service2_photo03_footer", "#btn_add_service2_photo03", ".btn_remove_service2_photo03",'',true);
