$(document).ready(function(){ 
	...
	$("#dynamic_product_photo").dynamicForm("#dynamic_product_photo_footer", "#btn_add_product_photo", ".btn_remove_product_photo",'',false);
		$("#dynamic_product_photo02").dynamicForm("#dynamic_product_photo02_footer", "#btn_add_product_photo02", ".btn_remove_product_photo02",'',true);
$('.btn_edit_seo').show();
}); 
