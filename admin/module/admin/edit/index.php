...
<tr >
    ...
    <td><input  name="givenname_en" id="givenname_en"  value="<?php echo $edit_data['givenname_en'] ?>" label="Name"  class="input_middle"  required="yes"/></td>
...
<tr style="display:none">
    ...
    <td><input  name="surname_en" id="surname_en"  value="<?php echo $edit_data['surname_en'] ?>" label="<?php echo TITLE_SURNAME_EN; ?>"  class="input_middle"/></td>
...
<input  name="expiry_date" id="expiry_date"  value="<?php echo $edit_data['expiry_date'] ?>" label="<?php echo TITLE_EXPIRY_DATE; ?>"  class="input_middle input_date" required="yes"/>
...
<tr>
	...
	<td class="title" style="vertical-align:top">Internal Remarks</td>
    <td><textarea  name="remark" id="remark"   class="input_middle" ><?php echo $edit_data['remark'] ?></textarea></td>
...
<table border="0" cellspacing="2" cellpadding="0"  id="table_text2">
  ...
  <tr>
     ...
     <br>
     <?php echo NOTICE_BEST_VIEW_PART_1; ?><?php echo TITLE_WIDTH; ?> : 112, <?php echo TITLE_HEIGHT; ?> : 120<?php echo NOTICE_BEST_VIEW_PART_2; ?> 
     <br>
...
<input name="member_photo_img" id="member_photo_img"  value="" label="<?php echo TITLE_IMG;?>" type="file" class="input_file file_upload"/>
<input name="member_photo_img_old_path"  id="member_photo_img_old_path" value="" type="hidden"/>
    </td>
...
?>
    ...
    <td style="display:none"><input name="member_photo_sort_order" id="member_photo_sort_order"  value="" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
...
?>
    ...
    <td style="width:250px;"><a href="#"  class="button btn_remove_member_photo" style="display:none"><span><?php echo BTN_REMOVE;?></span></a></td>
  </tr>
...
<a href="<?php echo $member_photo_img; ?>" target="_blank"><img src="<?php echo $member_photo_img_thumb?>"  style="margin-bottom:10px;" align="middle" width="<?php echo $arr_file_info['width'] ?>" height="<?php echo $arr_file_info['height'] ?>"/></a>
</div>
</div>
<br>
<input name="member_photo_img[]" id="member_photo_img[]"  value="" label="<?php echo TITLE_PHOTO;?>" type="file" class="input_file img_upload"/>
<input name="member_photo_img_old_path[]"  id="member_photo_img_old_path[]" value="<?php echo $data['img']; ?>" type="hidden"/>
    </td>
...
?>
    ...
    <td style="display:none"><input name="member_photo_sort_order[]" id="member_photo_sort_order[]"  value="<?php echo $data['sort_order']; ?>" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
...
?>
  ...
  <tr id="dynamic_member_photo_footer" style="display:none">
   <td colspan="5">&nbsp;</td>
  </tr>
...
<div style="float:left;"><a href="#" id="btn_add_member_photo" class="button btn_add_member_photo" style="display:none"><span><?php echo BTN_ADD_PHOTO;?></span></a></div>
...
?>
     ...
     <li style="display:none"><a href="#" class="btn_send_login"><span>Confirm and send login info</span></a></li>
<?php
	}
?> 
