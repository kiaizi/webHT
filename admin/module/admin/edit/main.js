$(document).ready(function(){ 
	...
	$(".btn_send_login").click(function(e){	
				...
				$('#frm_this_page #send_login').val('1');
				validForm();
	...
	$("#country_group_id").change(function(e){	
		...
		$("#dynamic_member_photo").dynamicForm("#dynamic_member_photo_footer", "#btn_add_member_photo", ".btn_remove_member_photo",'',false);
