<?php 
	...
	//$G_DB_CONNECT->query("update ".TB_MEMBER." set create_by=id where create_by='0' ");
?>
...
?>
 ...
 <div class="button_box">
    <ul>
      <li style="display:none"><a href="#" class="button" id="btn_export_excel"><span>Export All Data (.xls)</span></a></li>
      <li style="display:none"><a href="#" class="button" id="btn_export_excel"><span>Export All Data (.xls)</span></a></li>
