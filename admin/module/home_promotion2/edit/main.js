$(document).ready(function(){ 
	...
	$("#dynamic_home_promotion2_photo").dynamicForm("#dynamic_home_promotion2_photo_footer", "#btn_add_home_promotion2_photo", ".btn_remove_home_promotion2_photo",'',false);
	$("#dynamic_home_promotion2_photo02").dynamicForm("#dynamic_home_promotion2_photo02_footer", "#btn_add_home_promotion2_photo02", ".btn_remove_home_promotion2_photo02",'',false);
