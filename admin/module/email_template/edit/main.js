$(document).ready(function(){ 
	...
	//$("#dynamic_email_template_photo").dynamicFrom("#dynamic_email_template_photo_footer", "#btn_add_email_template_photo", ".btn_remove_email_template_photo",'',true);
