$(document).ready(function(){ 
	...
	$("#dynamic_service_photo").dynamicForm("#dynamic_service_photo_footer", "#btn_add_service_photo", ".btn_remove_service_photo",'',false);
	$("#dynamic_service_photo03").dynamicForm("#dynamic_service_photo03_footer", "#btn_add_service_photo03", ".btn_remove_service_photo03",'',false);

	$("#dynamic_service_photo02").dynamicForm("#dynamic_service_photo02_footer", "#btn_add_service_photo02", ".btn_remove_service_photo02",'',false);
$('.btn_edit_seo').show();
}); 
