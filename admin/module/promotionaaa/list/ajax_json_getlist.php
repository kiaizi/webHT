...
//	$return_data['table_list_content'] .= '<th width="100"><a href="#" class="orderby_title" orderby="display_date"><span>'.TITLE_DATE.'</span></a></th>';
	...
	// table content
	//////////////////////////////////////////////////////////
	$sql = "select promotion.*,promotion_desc.name as name from ".TB_PROMOTION." as promotion, ".TB_PROMOTION_DESC." as promotion_desc ";
	$sql .= " where ";
...
//////////////////////////////////////////////////////////
	...
	$return_data['table_list_content'] .= getFirstPhoto(TB_PROMOTION_PHOTO," promotion_id='".$data['id']."' ","thumb",100,500);
