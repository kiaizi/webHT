...
<table border="0" cellspacing="0" cellpadding="0" id="table_form" width="100%">
    ...
    <?php
printLangInputField('了解更多連結',"url",TB_WEBPAGE,$edit_data['id'],"url",false);
...
<?php 
		...
		//echo printLangTextAreaOneRow(TITLE_CONTENT,"detail",TB_WEBPAGE,$edit_data['id'],false,800,800);
...
<tr>
	<td class="sign_must_enter"></td>
	<td class="title vtop"  style="padding-top:5px;">背景</td>
...
<table border="0" cellspacing="2" cellpadding="0"  id="table_text2">
  ...
  <tr>
     ...
     <br>
     <?php echo NOTICE_BEST_VIEW_PART_1; ?><?php echo TITLE_WIDTH; ?> : 1920, <?php echo TITLE_HEIGHT; ?> : 1170<?php echo NOTICE_BEST_VIEW_PART_2; ?> 
