$(document).ready(function(){ 
	...
	$("#dynamic_download_software_photo").dynamicForm("#dynamic_download_software_photo_footer", "#btn_add_download_software_photo", ".btn_remove_download_software_photo",'',true);
		$("#dynamic_download_software_photo02").dynamicForm("#dynamic_download_software_photo02_footer", "#btn_add_download_software_photo02", ".btn_remove_download_software_photo02",'',true);
