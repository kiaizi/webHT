...
<?php 
   ...
   $sql = "select deposit_category.*, deposit_category_desc.name as name from ".TB_DEPOSIT_CATEGORY." as deposit_category , ".TB_DEPOSIT_CATEGORY_DESC." as deposit_category_desc ";
	...
	$sql .= " and deposit_category_desc.language_id='".ADMIN_LANG_ID."' ";
	$sql .= " group by deposit_category.id  ";
	$sql .= " order by deposit_category.sort_order asc ";
				

	printCustomMenu('search_deposit_category_id', $sql,'name','',$_REQUEST['search_deposit_category_id'],'',TITLE_ALL,'-1','');
