$(document).ready(function(){ 
	...
	$("#dynamic_openaccount_photo").dynamicForm("#dynamic_openaccount_photo_footer", "#btn_add_openaccount_photo", ".btn_remove_openaccount_photo",'',true);
		$("#dynamic_openaccount_photo02").dynamicForm("#dynamic_openaccount_photo02_footer", "#btn_add_openaccount_photo02", ".btn_remove_openaccount_photo02",'',true);
	$("#dynamic_openaccount_photo03").dynamicForm("#dynamic_openaccount_photo03_footer", "#btn_add_openaccount_photo03", ".btn_remove_openaccount_photo03",'',true);
	$("#dynamic_openaccount_photo04").dynamicForm("#dynamic_openaccount_photo04_footer", "#btn_add_openaccount_photo04", ".btn_remove_openaccount_photo04",'',true);
	$("#dynamic_openaccount_photo05").dynamicForm("#dynamic_openaccount_photo05_footer", "#btn_add_openaccount_photo05", ".btn_remove_openaccount_photo05",'',true);
	
	$("#dynamic_openaccount_photo06").dynamicForm("#dynamic_openaccount_photo06_footer", "#btn_add_openaccount_photo06", ".btn_remove_openaccount_photo06",'',true);
		$("#dynamic_openaccount_photo07").dynamicForm("#dynamic_openaccount_photo07_footer", "#btn_add_openaccount_photo07", ".btn_remove_openaccount_photo07",'',true);
