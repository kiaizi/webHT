...
//////////////////////////////////////////////////////////
	...
	if(ACTION == '1'){
		/*
			$sql = "select form_option3.* from ".TB_FORM_OPTION3." as form_option3, ".TB_FORM_OPTION3_DESC." as form_option3_desc ";
			$sql .= " where ";
			$sql .= " form_option3_desc.name='".getRequestVar('name_'.DEFAULT_FRONT_LANG_ID,'')."'  ";
			$sql .= " and form_option3_desc.language_id='".DEFAULT_FRONT_LANG_ID."'  ";
			$sql .= " and form_option3_desc.form_option3_id=form_option3.id ";
			$sql .= " and form_option3.disabled <> '".DISABLED_DELETE."' ";
			//$sql .= " form_option3.id<>'".$update_data['id']."'  ";
		...
		*/
		...
		if($return_data['success']){
			...
			$return_data['id'] = $update_data['id'] = $G_DB_CONNECT->query_insert(TB_FORM_OPTION3, $update_data); 
			$update_data_lang['form_option3_id'] = $return_data['id'];
			$G_DB_CONNECT->query_insert_lang_content(TB_FORM_OPTION3, $update_data_lang);
...
/*
			...
			$sql .= " and form_option3_desc.language_id='".DEFAULT_FRONT_LANG_ID."'  ";
			$sql .= " and form_option3_desc.form_option3_id=form_option3.id ";
			$sql .= " and form_option3.id<>'".$update_data['id']."'  ";
			$sql .= " and form_option3.disabled <> '".DISABLED_DELETE."' ";
			$rows = $G_DB_CONNECT->query($sql);
			if($G_DB_CONNECT->affected_rows > 0){
				$return_data['warn_msg'] = TITLE_TITLE.WARN_EXIST ;
		...
		*/
		...
		//////////////////////////////////////////////////////////
		if($return_data['success']){
			$G_DB_CONNECT->query_update(TB_FORM_OPTION3, $update_data, "id='".$update_data['id']."'"); 
			$update_data_lang['form_option3_id'] = $return_data['id'];
			$G_DB_CONNECT->query_update_lang_content(TB_FORM_OPTION3, $update_data_lang, "  form_option3_id='".$update_data['id']."'   ");
		}
	...
	if($update_data['seo_url'] == ''){
		$G_DB_CONNECT->query("update ".TB_FORM_OPTION3." set seo_url='".$return_data['id']."'  where id='".$return_data['id']."' ");
	}
	...
	//////////////////////////////////////////////////////////
	if(ACTION == '3'){
			deleteRecord(TB_FORM_OPTION3,$update_data['id'],true,'');
	...
	//////////////////////////////////////////////////////////
  	...
  	renewSortOrder(TB_FORM_OPTION3," id>0 ");
