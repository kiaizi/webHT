$(document).ready(function(){ 
	...
	$("#dynamic_important_notice_category_photo").dynamicForm("#dynamic_important_notice_category_photo_footer", "#btn_add_important_notice_category_photo", ".btn_remove_important_notice_category_photo",'',true);
		$("#dynamic_important_notice_category_photo02").dynamicForm("#dynamic_important_notice_category_photo02_footer", "#btn_add_important_notice_category_photo02", ".btn_remove_important_notice_category_photo02",'',false);
		$("#dynamic_important_notice_category_photo03").dynamicForm("#dynamic_important_notice_category_photo03_footer", "#btn_add_important_notice_category_photo03", ".btn_remove_important_notice_category_photo03",'',false);
//$('.btn_edit_seo').show();
}); 
