...
<?php 
		...
		//echo printLangTextAreaOneRow(TITLE_CONTENT,"detail",TB_WEBPAGE,$edit_data['id'],false,500,800);
...
<table border="0" cellspacing="2" cellpadding="0"  id="table_text2">
  ...
  <tr>
     ...
     <br>
     <?php echo NOTICE_BEST_VIEW_PART_1; ?><?php echo TITLE_WIDTH; ?> : 480, <?php echo TITLE_HEIGHT; ?> : 325<?php echo NOTICE_BEST_VIEW_PART_2; ?> 
