...
printLangTextAreaNormal('Title 1',"name",TB_WEBPAGE,$edit_data['id'],false,50,510);
printLangTextAreaNormal('Subtitle 1',"name2",TB_WEBPAGE,$edit_data['id'],false,100,510);



printLangTextAreaNormal('Title 2',"name3",TB_WEBPAGE,$edit_data['id'],false,50,510);
	
echo printLangTextArea('Introduction ',"detail",TB_WEBPAGE,$edit_data['id'],false,500,800);
...
<?php 
	...
	echo printLangTextAreaOneRow(TITLE_CONTENT." (footer)","detail2",TB_WEBPAGE,$edit_data['id'],false,500,980);
