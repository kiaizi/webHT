...
// upload file
/////////////////////////////////////////////
$arr_download_photo_title_sc = getRequestVar("download_photo_title_sc",'');
$arr_download_photo_title_tc = getRequestVar("download_photo_title_tc",'');
$arr_download_photo_title_en = getRequestVar("download_photo_title_en",'');
...
$arr_download_photo_img2_old_path = getRequestVar("download_photo_img2_old_path",'');
if($arr_download_photo_disabled != '' && ID > 0){
	...
	for ($i=0; $i<count($arr_download_photo_disabled); $i++) {
		...
		if($tempFile != ''){
			...
			$download_photo_img2_old_path = $arr_download_photo_img2_old_path[$i];
		$download_photo_img2 = $download_photo_img2_old_path;

		$dir = "upload/files/download/";
		$file_name = "download_photo_img2";
		////////////////////////////////////////////////
		$tempFile = $_FILES[$file_name]['tmp_name'][$i];
		if($tempFile != ''){
			$targetPath = CURRENT_DOCUMENT_ROOT . $dir ;
			...
			$download_photo_img2  = $targetFile;
		...
		if($download_photo_img != ''  || $download_photo_img2 != ''){
			////////////////////////////////////////////////
			...
			$update_download_photo_data['img2'] = $download_photo_img2;
			$update_download_photo_data['title_sc'] = $arr_download_photo_title_sc[$i];
			$update_download_photo_data['title_tc'] = $arr_download_photo_title_tc[$i];
			$update_download_photo_data['title_en'] = $arr_download_photo_title_en[$i];
...
<?php 
   	...
   	printLangInputField("SEO H1","seo_h1",TB_DOWNLOAD,$edit_data['id'],"seo_h1",false,"input_seo_title","",false,'class="seo_row"');
...
<?php 
   ...
   $sql = "select download_category.*, download_category_desc.name as name from ".TB_DOWNLOAD_CATEGORY." as download_category , ".TB_DOWNLOAD_CATEGORY_DESC." as download_category_desc ";
	$sql .= " where ";
	$sql .= " download_category.id=download_category_desc.download_category_id ";
	$sql .= " and download_category_desc.language_id='".ADMIN_LANG_ID."' and disabled<>'".DISABLED_DELETE."' ";
	$sql .= " order by download_category.sort_order asc ";
				

	printCustomMenu('download_category_id', $sql,'name','0',$edit_data['download_category_id'],'','','','');
...
<?php 
	...
	//printLangTextArea('參考資料',"detail2",TB_DOWNLOAD,$edit_data['id'],true,500,850);
...
<?php
		...
		while($data2 = $G_DB_CONNECT->fetch_array($rows2)){
			...
			$sql .= " from ".TB_DOWNLOAD_TO_PRODUCT_TYPE;
			$sql .= " where ";
			$sql .= " download_id = '".ID."' ";
...
<?php
		...
		while($data2 = $G_DB_CONNECT->fetch_array($rows2)){
			...
			$sql .= " from ".TB_DOWNLOAD_TO_PRODUCT;
			$sql .= " where ";
			$sql .= " download_id = '".ID."' ";
...
<?php
		...
		while($data2 = $G_DB_CONNECT->fetch_array($rows2)){
			...
			$sql .= " from ".TB_DOWNLOAD_TO_PRODUCT_CATEGORY;
			$sql .= " where ";
			$sql .= " download_id = '".ID."' ";
...
<?php
		...
		while($data2 = $G_DB_CONNECT->fetch_array($rows2)){
			...
			$sql .= " from ".TB_DOWNLOAD_TO_PRODUCT_CATEGORY2;
			$sql .= " where ";
			$sql .= " download_id = '".ID."' ";
...
<?php
		...
		while($data2 = $G_DB_CONNECT->fetch_array($rows2)){
			...
			$sql .= " from ".TB_DOWNLOAD_TO_PRODUCT_CATEGORY3;
			$sql .= " where ";
			$sql .= " download_id = '".ID."' ";
...
<input name="download_photo_img2" id="download_photo_img2"  value="" label="<?php echo TITLE_IMG;?>" type="file" class="input_file file_upload"/>
<input name="download_photo_img2_old_path"  id="download_photo_img2_old_path" value="" type="hidden"/>
    </td>
...
<textarea style="width:300px;height:50px;" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_SC;?>" name="download_photo_title_sc" id="download_photo_title_sc"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "></textarea>
  <div style="clear:both;padding-top:5px;"></div>
  <textarea style="width:300px;height:50px;display:none" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_TC;?>" name="download_photo_title_tc" id="download_photo_title_tc"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "></textarea>
        <div style="clear:both;padding-top:5px;"></div>
    <textarea style="width:300px;height:50px;" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_EN;?>" name="download_photo_title_en" id="download_photo_title_en"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "></textarea>
...
<td  style="vertical-align:top"><input  style="width:50px;" name="download_photo_sort_order" id="download_photo_sort_order"  value="" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
...
?>
    ...
    <td style="width:250px; vertical-align:top"><a href="#"  class="button btn_remove_download_photo"   ><span><?php echo BTN_REMOVE;?></span></a></td>
  </tr>
...
<div align="center">
<div style="width:<?php echo $photo_width; ?>px; vertical-align:top">
<a href="<?php echo $download_photo_img; ?>" target="_blank">按此查看档案</a>

</div>
</div>
<br>
<input name="download_photo_img2[]" id="download_photo_img2[]"  value="" label="<?php echo TITLE_PHOTO;?>" type="file" class="input_file img_upload"/>
<input name="download_photo_img2_old_path[]"  id="download_photo_img2_old_path[]" value="<?php echo $data['img2']; ?>" type="hidden"/>
    </td>
...
<textarea style="width:300px;height:50px;" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_SC;?>" name="download_photo_title_sc[]" id="download_photo_title_sc[]"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "><?php echo $data['title_sc']; ?></textarea>
  <div style="clear:both;padding-top:5px;"></div>
  <textarea style="width:300px;height:50px;display:none" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_TC;?>" name="download_photo_title_tc[]" id="download_photo_title_tc[]"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "><?php echo $data['title_tc']; ?></textarea>
        <div style="clear:both;padding-top:5px;"></div>
    <textarea style="width:300px;height:50px;" placeholder="<?php echo TITLE_TITLE;?> <?php echo TITLE_LANG_EN;?>" name="download_photo_title_en[]" id="download_photo_title_en[]"   label="<?php echo TITLE_SORT_ORDER;?>" class="input_short "><?php echo $data['title_en']; ?></textarea>
...
?>
   ...
   <td  style="vertical-align:top"><input  style="width:50px;" name="download_photo_sort_order[]" id="download_photo_sort_order[]"  value="<?php echo $data['sort_order']; ?>" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
