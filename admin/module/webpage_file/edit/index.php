...
<?php 
		...
		printLangInputField(TITLE_TITLE,"name",TB_WEBPAGE,$edit_data['id'],"name",false);
...
<tr>
	<td class="sign_must_enter"></td>
	<td class="title vtop"  style="padding-top:5px;">档案</td>
...
<table border="0" cellspacing="2" cellpadding="0"  id="table_text2">
  ...
  <tr>
  	 <td style="vertical-align:top">档案</td>
...
<a href="<?php echo $webpage_photo_img; ?>" target="_blank">查看已上载档案</a>
