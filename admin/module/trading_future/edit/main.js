$(document).ready(function(){ 
	...
	$("#dynamic_trading_future_photo").dynamicForm("#dynamic_trading_future_photo_footer", "#btn_add_trading_future_photo", ".btn_remove_trading_future_photo",'',true);
		$("#dynamic_trading_future_photo02").dynamicForm("#dynamic_trading_future_photo02_footer", "#btn_add_trading_future_photo02", ".btn_remove_trading_future_photo02",'',true);
