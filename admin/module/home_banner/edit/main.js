$(document).ready(function(){ 
	...
	$("#dynamic_home_banner_photo").dynamicForm("#dynamic_home_banner_photo_footer", "#btn_add_home_banner_photo", ".btn_remove_home_banner_photo",'',false);
	$("#dynamic_home_banner_photo02").dynamicForm("#dynamic_home_banner_photo02_footer", "#btn_add_home_banner_photo02", ".btn_remove_home_banner_photo02",'',false);
	$("#dynamic_home_banner_photo03").dynamicForm("#dynamic_home_banner_photo03_footer", "#btn_add_home_banner_photo03", ".btn_remove_home_banner_photo03",'',false);
...
function submitForm(this_form){
	...
	$("#"+this_form+' input' ).removeAttr('disabled');
	$("#"+this_form+' select' ).removeAttr('disabled');
