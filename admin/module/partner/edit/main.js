$(document).ready(function(){ 
	...
	$("#dynamic_partner_photo").dynamicForm("#dynamic_partner_photo_footer", "#btn_add_partner_photo", ".btn_remove_partner_photo",'',false);
		$("#dynamic_partner_photo02").dynamicForm("#dynamic_partner_photo02_footer", "#btn_add_partner_photo02", ".btn_remove_partner_photo02",'',true);
$('.btn_edit_seo').show();
}); 
