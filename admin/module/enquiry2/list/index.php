<?php 
	...
	//$G_DB_CONNECT->query("update ".TB_ENQUIRY2." set create_by=id where create_by='0' ");
?>
...
<a class="button" id="btn_print_order_form" href="index.php?sid=19&enquiry2_id=1" rel="lyteframe" title="" rev="width: 800px; height: 250px; scrolling: auto;" ><span><?php echo BTN_PRINT_ORDER_FORM; ?></span></a></div>
<!-- table_layout (start) -->
...
?>
 ...
 <div class="button_box">
    <ul>
    <li style="display:none"><a href="#" class="button" id="btn_export_excel"><span>Export all  (.xls)</span></a></li>
