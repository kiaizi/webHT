$(document).ready(function(){ 
	...
	$("#dynamic_medicalinfo_photo").dynamicForm("#dynamic_medicalinfo_photo_footer", "#btn_add_medicalinfo_photo", ".btn_remove_medicalinfo_photo",'',false);
		$("#dynamic_medicalinfo_photo02").dynamicForm("#dynamic_medicalinfo_photo02_footer", "#btn_add_medicalinfo_photo02", ".btn_remove_medicalinfo_photo02",'',true);
//$('.btn_edit_seo').show();
	$("#dynamic_medicalinfo_to_service").dynamicForm("#dynamic_medicalinfo_to_service_footer", "#btn_add_medicalinfo_to_service", ".btn_remove_medicalinfo_to_service",'',true);
