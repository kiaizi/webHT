$(document).ready(function(){ 
	...
	$("#dynamic_deposit_photo").dynamicForm("#dynamic_deposit_photo_footer", "#btn_add_deposit_photo", ".btn_remove_deposit_photo",'',true);
		$("#dynamic_deposit_photo02").dynamicForm("#dynamic_deposit_photo02_footer", "#btn_add_deposit_photo02", ".btn_remove_deposit_photo02",'',true);
