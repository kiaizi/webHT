$(document).ready(function(){ 
	...
	$("#dynamic_important_notice_photo").dynamicForm("#dynamic_important_notice_photo_footer", "#btn_add_important_notice_photo", ".btn_remove_important_notice_photo",'',false);
		$("#dynamic_important_notice_pdf").dynamicForm("#dynamic_important_notice_pdf_footer", "#btn_add_important_notice_pdf", ".btn_remove_important_notice_pdf",'',false);
