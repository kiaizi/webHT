$(document).ready(function(){ 
	...
	$("#dynamic_retailer_photo").dynamicForm("#dynamic_retailer_photo_footer", "#btn_add_retailer_photo", ".btn_remove_retailer_photo",'',false);
		$("#dynamic_retailer_photo02").dynamicForm("#dynamic_retailer_photo02_footer", "#btn_add_retailer_photo02", ".btn_remove_retailer_photo02",'',true);
$('.btn_edit_seo').show();
}); 
