...
<div align="center">
<table border="0" cellspacing="0" cellpadding="0" id="table_nopad" style="<?php if(SID == 8){ echo 'width:580px'; } ?>">
  <tr>
    <td style="padding:0">
<div class="button_box" style="clear:none">
    ...
    <li ><a href="#" id="btn_create"><span><?php echo BTN_CONTINUE_CREATE;?><?php echo DATA_NAME;?></span></a></li>
    <li><a href="#" id="btn_back_to_list" class="btn_back_to_list"><span><?php echo BTN_BACK_TO_LIST;?></span></a></li>
    </ul>
	</div>
