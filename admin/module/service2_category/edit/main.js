$(document).ready(function(){ 
	...
	$("#dynamic_service2_category_photo").dynamicForm("#dynamic_service2_category_photo_footer", "#btn_add_service2_category_photo", ".btn_remove_service2_category_photo",'',true);
		$("#dynamic_service2_category_photo02").dynamicForm("#dynamic_service2_category_photo02_footer", "#btn_add_service2_category_photo02", ".btn_remove_service2_category_photo02",'',false);
		$("#dynamic_service2_category_photo03").dynamicForm("#dynamic_service2_category_photo03_footer", "#btn_add_service2_category_photo03", ".btn_remove_service2_category_photo03",'',false);
//$('.btn_edit_seo').show();
}); 
