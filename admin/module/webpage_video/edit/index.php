...
// upload file
/////////////////////////////////////////////
$arr_webpage_photo02_youtube_id = getRequestVar("webpage_photo02_youtube_id",'');
...
if($arr_webpage_photo02_disabled != '' && ID > 0){
	...
	for ($i=0; $i<count($arr_webpage_photo02_disabled); $i++) {
		...
		if($arr_webpage_photo02_youtube_id[$i] != ''){
		
	//	if($webpage_photo02_img != '' || $webpage_photo02_img2 != ''){
			////////////////////////////////////////////////
			$update_webpage_photo02_data = array();
			$update_webpage_photo02_data['youtube_id'] = $arr_webpage_photo02_youtube_id[$i];
...
//renewSortOrder(TB_WEBPAGE_PHOTO02,"webpage_id='".ID."'");
...
echo printLangTextArea('Introduction ',"detail",TB_WEBPAGE,$edit_data['id'],false,500,680);
...
<tr>
	<td class="sign_must_enter"></td>
	<td class="title vtop"  style="padding-top:5px;">Video</td>
...
<table border="0" cellspacing="2" cellpadding="0"  id="table_text2">
  ...
  <tr>
  	 <td style="vertical-align:top;display:none"><?php echo TITLE_IMG ?> 
     ...
     <br><?php echo NOTICE_FILE_FORMAT; ?> jpg, png, gif</td>
      ...
      <td  style="vertical-align:top; padding-top:5px;display:none "><?php echo TITLE_LANG ?></td>
	        <td style="vertical-align:top; padding-left:0px ">Youtube ID</td>
...
?>
       ...
       <td  style="padding-left:0px">https://www.youtube.com/watch?v=<input name="webpage_photo02_youtube_id" id="webpage_photo02_youtube_id"  value="" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short"   style="width:150px;"/></td>
...
?>
           ...
           <td style="padding-left:0px">https://www.youtube.com/watch?v=<input name="webpage_photo02_youtube_id[]" id="webpage_photo02_youtube_id[]"  value="<?php echo $data['youtube_id']; ?>" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short"   style="width:150px;"/></td>
...
<?php 
	...
	echo printLangTextArea(TITLE_CONTENT." (footer)","detail2",TB_WEBPAGE,$edit_data['id'],false,500,980);
