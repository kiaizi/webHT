$(document).ready(function(){ 
	...
	$("#dynamic_showcase_photo").dynamicForm("#dynamic_showcase_photo_footer", "#btn_add_showcase_photo", ".btn_remove_showcase_photo",'',false);
		$("#dynamic_showcase_photo02").dynamicForm("#dynamic_showcase_photo02_footer", "#btn_add_showcase_photo02", ".btn_remove_showcase_photo02",'',true);
$('.btn_edit_seo').show();
}); 
