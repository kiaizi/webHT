<?php 
	...
	//$G_DB_CONNECT->query("update ".TB_EMAIL_LIST." set create_by=id where create_by='0' ");
?>
...
<a class="button" id="btn_print_order_form" href="index.php?sid=19&email_list_id=1" rel="lyteframe" title="" rev="width: 800px; height: 250px; scrolling: auto;" ><span><?php echo BTN_PRINT_ORDER_FORM; ?></span></a></div>
<!-- table_layout (start) -->
...
<?php
		...
		/*
						array(  
                    		LIST_ACTION_DISABLE_USER ,
							'1'
						),
						array(  
                    		LIST_ACTION_ENABLE_USER ,
							'2'
						) ,
...
?>
 ...
 <div class="button_box">
    <ul>
    <li><a href="#" class="button" id="btn_export_excel"><span>匯出 (.xls)</span></a></li>
