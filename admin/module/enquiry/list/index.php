<?php 
	...
	//$G_DB_CONNECT->query("update ".TB_ENQUIRY." set create_by=id where create_by='0' ");
?>
...
<script type="text/javascript" src="<?php echo DIR_THIS_MODULE_ACTION;?>main.js?v=2222"></script>
</head>
<body style="width:2400px">
<div id="container">
...
<a class="button" id="btn_print_order_form" href="index.php?sid=19&enquiry_id=1" rel="lyteframe" title="" rev="width: 800px; height: 250px; scrolling: auto;" ><span><?php echo BTN_PRINT_ORDER_FORM; ?></span></a></div>
<!-- table_layout (start) -->
