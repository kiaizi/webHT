...
<?php
printLangInputField('Title',"name",TB_WEBPAGE,$edit_data['id'],"name",false);
printLangInputField('Sub Title',"name2",TB_WEBPAGE,$edit_data['id'],"name2",false);
...
<?php 
		...
		echo printLangTextAreaOneRow(TITLE_CONTENT,"detail",TB_WEBPAGE,$edit_data['id'],false,500,560);
