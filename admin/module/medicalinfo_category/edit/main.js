$(document).ready(function(){ 
	...
	$("#dynamic_medicalinfo_category_photo").dynamicForm("#dynamic_medicalinfo_category_photo_footer", "#btn_add_medicalinfo_category_photo", ".btn_remove_medicalinfo_category_photo",'',true);
		$("#dynamic_medicalinfo_category_photo02").dynamicForm("#dynamic_medicalinfo_category_photo02_footer", "#btn_add_medicalinfo_category_photo02", ".btn_remove_medicalinfo_category_photo02",'',false);
		$("#dynamic_medicalinfo_category_photo03").dynamicForm("#dynamic_medicalinfo_category_photo03_footer", "#btn_add_medicalinfo_category_photo03", ".btn_remove_medicalinfo_category_photo03",'',false);
//$('.btn_edit_seo').show();
}); 
