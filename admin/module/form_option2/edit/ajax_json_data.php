...
//////////////////////////////////////////////////////////
	...
	if(ACTION == '1'){
		/*
			$sql = "select form_option2.* from ".TB_FORM_OPTION2." as form_option2, ".TB_FORM_OPTION2_DESC." as form_option2_desc ";
			$sql .= " where ";
			$sql .= " form_option2_desc.name='".getRequestVar('name_'.DEFAULT_FRONT_LANG_ID,'')."'  ";
			$sql .= " and form_option2_desc.language_id='".DEFAULT_FRONT_LANG_ID."'  ";
			$sql .= " and form_option2_desc.form_option2_id=form_option2.id ";
			$sql .= " and form_option2.disabled <> '".DISABLED_DELETE."' ";
			//$sql .= " form_option2.id<>'".$update_data['id']."'  ";
		...
		*/
		...
		if($return_data['success']){
			...
			$return_data['id'] = $update_data['id'] = $G_DB_CONNECT->query_insert(TB_FORM_OPTION2, $update_data); 
			$update_data_lang['form_option2_id'] = $return_data['id'];
			$G_DB_CONNECT->query_insert_lang_content(TB_FORM_OPTION2, $update_data_lang);
...
/*
			...
			$sql .= " and form_option2_desc.language_id='".DEFAULT_FRONT_LANG_ID."'  ";
			$sql .= " and form_option2_desc.form_option2_id=form_option2.id ";
			$sql .= " and form_option2.id<>'".$update_data['id']."'  ";
			$sql .= " and form_option2.disabled <> '".DISABLED_DELETE."' ";
			$rows = $G_DB_CONNECT->query($sql);
			if($G_DB_CONNECT->affected_rows > 0){
				$return_data['warn_msg'] = TITLE_TITLE.WARN_EXIST ;
		...
		*/
		...
		//////////////////////////////////////////////////////////
		if($return_data['success']){
			$G_DB_CONNECT->query_update(TB_FORM_OPTION2, $update_data, "id='".$update_data['id']."'"); 
			$update_data_lang['form_option2_id'] = $return_data['id'];
			$G_DB_CONNECT->query_update_lang_content(TB_FORM_OPTION2, $update_data_lang, "  form_option2_id='".$update_data['id']."'   ");
		}
	...
	if($update_data['seo_url'] == ''){
		$G_DB_CONNECT->query("update ".TB_FORM_OPTION2." set seo_url='".$return_data['id']."'  where id='".$return_data['id']."' ");
	}
	...
	//////////////////////////////////////////////////////////
	if(ACTION == '3'){
			deleteRecord(TB_FORM_OPTION2,$update_data['id'],true,'');
	...
	//////////////////////////////////////////////////////////
  	...
  	renewSortOrder(TB_FORM_OPTION2," id>0 ");
