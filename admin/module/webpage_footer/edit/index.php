...
<?php 
	...
	echo printLangTextArea(TITLE_CONTENT,"detail",TB_WEBPAGE,$edit_data['id'],false,400,980);



			echo printLangTextArea('友情链接 ',"detail3",TB_WEBPAGE,$edit_data['id'],false,300,980);


		
	
	echo printLangTextArea('Copyright ',"detail2",TB_WEBPAGE,$edit_data['id'],false,300,980);
   	...
   	printLangInputField('关注我们 (標題)',"name2",TB_WEBPAGE,$edit_data['id'],"name2",false);


   	printLangInputField('关注我们 (描述)',"name3",TB_WEBPAGE,$edit_data['id'],"name3",false);
...
<tr>
	<td class="sign_must_enter"></td>
	<td class="title vtop"  style="padding-top:5px;">关注我们 (QRCODE)</td>
