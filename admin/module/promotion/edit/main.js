$(document).ready(function(){ 
	...
	$("#dynamic_promotion_photo").dynamicForm("#dynamic_promotion_photo_footer", "#btn_add_promotion_photo", ".btn_remove_promotion_photo",'',false);
		//$("#dynamic_promotion_photo02").dynamicForm("#dynamic_promotion_photo02_footer", "#btn_add_promotion_photo02", ".btn_remove_promotion_photo02",'',true);
$('.btn_edit_seo').show();
}); 
