...
// upload file
/////////////////////////////////////////////
$arr_promotion_photo02_title_tc = getRequestVar("promotion_photo02_title_tc",'');
$arr_promotion_photo02_detail_tc = getRequestVar("promotion_photo02_detail_tc",'');

$arr_promotion_photo02_language_id = getRequestVar("promotion_photo02_language_id",'');
$arr_promotion_photo02_sort_order = getRequestVar("promotion_photo02_sort_order",'');
$arr_promotion_photo02_caption = getRequestVar("promotion_photo02_caption",'');
$arr_promotion_photo02_disabled = getRequestVar("promotion_photo02_disabled",'');
$arr_promotion_photo02_img_old_path = getRequestVar("promotion_photo02_img_old_path",'');
$arr_promotion_photo02_thumb_old_path = getRequestVar("promotion_photo02_thumb_old_path",'');
if($arr_promotion_photo02_disabled != '' && ID > 0){

	$promotion_id = ID;
	//$promotion_code = getDataName(TB_PROMOTION,"code",$promotion_id);
	$sql = "delete from ".TB_PROMOTION_PHOTO02." where promotion_id='".$promotion_id."'";
	$G_DB_CONNECT->query($sql);

	for ($i=0; $i<count($arr_promotion_photo02_disabled); $i++) {




		$promotion_photo02_img_old_path = $arr_promotion_photo02_img_old_path[$i];
		$promotion_photo02_img = $promotion_photo02_img_old_path;

		$dir = "upload/images/promotion/";
		$file_name = "promotion_photo02_img";
		////////////////////////////////////////////////
		$tempFile = $_FILES[$file_name]['tmp_name'][$i];
		if($tempFile != ''){
			$targetPath = CURRENT_DOCUMENT_ROOT . $dir ;
			$ext = get_extension($_FILES[$file_name]['name'][$i]);
			//$new_file_name = $promotion_code."_".date("YmdHis")."_".getLastID(TB_PROMOTION_PHOTO02).$ext;
			$new_file_name = date("YmdHis")."_".getLastID(TB_PROMOTION_PHOTO02).'_feature'.$ext;
  			$targetFile =  str_replace('//','/',$targetPath) .$new_file_name ;
			move_uploaded_file($tempFile,$targetFile);
			$targetFile =$dir.$new_file_name;
			////////////////////////////////////////////////

			$promotion_photo02_img  = $targetFile;
		...
		if($promotion_photo02_img != '' ){
			////////////////////////////////////////////////
			$update_promotion_photo02_data = array();
			$update_promotion_photo02_data['language_id'] = $arr_promotion_photo02_language_id[$i];
			$update_promotion_photo02_data['img'] = $promotion_photo02_img;
		//	$update_promotion_photo02_data['thumb'] = $promotion_photo02_thumb;
			//$update_promotion_photo02_data['caption'] = $arr_promotion_photo02_caption[$i];
			$update_promotion_photo02_data['title_tc'] = $arr_promotion_photo02_title_tc[$i];
			$update_promotion_photo02_data['detail_tc'] = $arr_promotion_photo02_detail_tc[$i];
			$update_promotion_photo02_data['sort_order'] = $arr_promotion_photo02_sort_order[$i];
			$update_promotion_photo02_data['disabled'] = $arr_promotion_photo02_disabled[$i];
			$update_promotion_photo02_data['promotion_id'] = $promotion_id;
			$update_promotion_photo02_data['create_date'] = 'null';
			$update_promotion_photo02_data['create_by'] = '';
			$update_promotion_photo02_data['last_update_by'] = '';
			$G_DB_CONNECT->query_insert(TB_PROMOTION_PHOTO02, $update_promotion_photo02_data);
			////////////////////////////////////////////////
...
<?php 
	...
	printLangTextArea(TITLE_CONTENT,"detail",TB_PROMOTION,$edit_data['id'],true,500,980);
...
<table border="0" cellspacing="2" cellpadding="0"  id="table_text2">
  ...
  <tr>
     ...
     <br>
     <?php echo NOTICE_BEST_VIEW_PART_1; ?><?php echo TITLE_WIDTH; ?> : 770,<?php echo TITLE_HEIGHT; ?> : 480 <?php echo NOTICE_BEST_VIEW_PART_2; ?> 
     <br>
...
<td style="display:none"><input name="promotion_photo_sort_order" id="promotion_photo_sort_order"  value="" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
...
?>
    ...
    <td style="width:250px;"><a href="#"  style="display:none"  class="button btn_remove_promotion_photo"   ><span><?php echo BTN_REMOVE;?></span></a></td>
  </tr>
...
?>
   ...
   <td style="display:none"><input name="promotion_photo_sort_order[]" id="promotion_photo_sort_order[]"  value="<?php echo $data['sort_order']; ?>" label="<?php echo TITLE_SORT_ORDER;?>" class="input_short sort_order"   maxlength="5"/></td>
...
<div style="float:left;"><a  href="#" style="display:none"  id="btn_add_promotion_photo" class="button btn_add_promotion_photo"  ><span><?php echo BTN_ADD_PHOTO;?></span></a></div>
