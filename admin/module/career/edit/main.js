$(document).ready(function(){ 
	...
	$("#dynamic_career_photo").dynamicForm("#dynamic_career_photo_footer", "#btn_add_career_photo", ".btn_remove_career_photo",'',true);
		$("#dynamic_career_photo02").dynamicForm("#dynamic_career_photo02_footer", "#btn_add_career_photo02", ".btn_remove_career_photo02",'',true);
//$('.btn_edit_seo').show();
}); 
