...
class AlipaySubmit {
	...
	function buildForm($para_temp, $gateway, $method, $button_name, $aliapy_config) {
		...
		$sHtml = "<form id='alipaysubmit' name='alipaysubmit' action='".$gateway."_input_charset=".trim(strtolower($aliapy_config['input_charset']))."' method='".$method."' target='_self'>";
		...
		//$sHtml = $sHtml."<div style='width:100%; padding-top:100px; font-size:13px; font-weight:bold; text-align:center;'><img src='includes/classes/payment_gateway/alipay/images/alipay.gif'><br><br><img src='includes/classes/payment_gateway/alipay/images/loading.jpg'></div>";
