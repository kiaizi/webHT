...
class rc_paginator_Output extends rc_paginator
{
	 ...
	 *	@var String
	 */
	var $linkTmpl = '<li><a href="HREF" class="paging_link2 CURRENT" title="TITLE" page="PAGE">DESCRIBE</a></li>';
	...
	{
		$this->linkTmpl = '<li><a href="HREF" class="paging_link2 CURRENT" title="TITLE" page="PAGE">DESCRIBE</a></li>';
	}
