<?php
include_once("includes/upload/easyupload/upload_class.php");
...
$foto_upload->upload_dir = "files/"; // "files" is the folder for the uploaded files (you have to create these folder)
$foto_upload->foto_folder = "files/photo/";
$foto_upload->thumb_folder = "files/thumb/";
